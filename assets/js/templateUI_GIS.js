$(document).ready(function () {
  ...
  $("#myJenis").change(function () {
    ...
    $(this).val() == "NDVI-Level Of Greennes" ||
  ...
  $("#ImageUploadButton").on("click", function () {
    if ($("#myJenis").val() == "NDVI-NDVI" ||
    $("#myJenis").val() == "NDVI-Plant Weight" ||
    $("#myJenis").val() == "NDVI-Plant Disease" ||
    $("#myJenis").val() == "NDVI-Sufficiency Of Water" ||
    $("#myJenis").val() == "NDVI-Suggestion") {
      if (!$("#ImageUploadButton").hasClass("uploading")) {
        if ($("#myJenis").val() == "DSM-Water Logging") {
          ...
          if ($("#newPostImage").val() != "" && $("#newPostPDF").val() != "" && $("#newPostExcel").val() != "") {
            uploadImage();
            $("#ImageUploadButton").addClass("uploading");
          } else {
            document.querySelector("#alertModalText").innerHTML =
              "Please insert both Image, Pdf file and Excel";
              $("#unModal").modal();
          }
        }
      }
