...
class Report extends CI_Controller {
	...
	function history_login(){
		...
		if(isset($_SESSION['username'])){
			...
			$data['cb'] = $this->input->get('cb');
			if($data['cb'] != NULL){
				$tanggal = date("Y-m-t" ,strtotime(date("Y-").substr($tanggal, 0, 2)."-01"));
				// die($tanggal);
				$tgl = date('Y-m-t', strtotime($tanggal));
				$data['tgl'] = date('Y-m-t', strtotime($tanggal));
			}
			else{
				if($tanggal != NULL){
					$tgl = date('Y-').$tanggal;
					$data['tgl'] = date('Y-').$tanggal;
				}
				else{
					$tgl = date('Y-m-d');
					$data['tgl'] = date('Y-m-d');
			...
			if($_SESSION['crud'] == 0 || $_SESSION['index'] == "01334" || $_SESSION['index'] == "10007809" || $_SESSION['index'] == "10003609" || $_SESSION['index'] == "04660"){
				$data['PG1'] = array(
					'sn_manager' => $this->User_model->get_history_login_index("Sub Div Head PG1", "PG1", $tgl),
					'ppic_manager' => $this->User_model->get_history_login_index("Dept Head PPIC PG1", "PG1", $tgl),
					'fs_manager' => $this->User_model->get_history_login_index("Dept Head FS PG1", "PG1", $tgl),
				...
				$data['PG2'] = array(
					'sn_manager' => $this->User_model->get_history_login_index("Sub Div Head PG2", "PG2", $tgl),
					'ppic_manager' => $this->User_model->get_history_login_index("Dept Head PPIC PG2", "PG2", $tgl),
					'fs_manager' => $this->User_model->get_history_login_index("Dept Head FS PG2", "PG2", $tgl),
				...
				$data['PG3'] = array(
					'sn_manager' => $this->User_model->get_history_login_index("Sub Div Head PG3", "PG3", $tgl),
					'ppic_manager' => $this->User_model->get_history_login_index("Dept Head PPIC PG3", "PG3", $tgl),
					'fs_manager' => $this->User_model->get_history_login_index("Dept Head FS PG3", "PG3", $tgl),
				...
				$data['PG1_all'] = array(
					'sn_manager' => $this->User_model->get_history_login_all_index("Sub Div Head PG1", "PG1", $tgl),
					'ppic_manager' => $this->User_model->get_history_login_all_index("Dept Head PPIC PG1", "PG1", $tgl),
					'fs_manager' => $this->User_model->get_history_login_all_index("Dept Head FS PG1", "PG1", $tgl),
				...
				$data['PG2_all'] = array(
					'sn_manager' => $this->User_model->get_history_login_all_index("Sub Div Head PG2", "PG2", $tgl),
					'ppic_manager' => $this->User_model->get_history_login_all_index("Dept Head PPIC PG2", "PG2", $tgl),
					'fs_manager' => $this->User_model->get_history_login_all_index("Dept Head FS PG2", "PG2", $tgl),
				...
				$data['PG3_all'] = array(
					'sn_manager' => $this->User_model->get_history_login_all_index("Sub Div Head PG3", "PG3", $tgl),
					'ppic_manager' => $this->User_model->get_history_login_all_index("Dept Head PPIC PG3", "PG3", $tgl),
					'fs_manager' => $this->User_model->get_history_login_all_index("Dept Head FS PG3", "PG3", $tgl),
			    ...
			    $pg_code = NULL;
			    if(strpos($_SESSION['deskripsi'], "PG1")){
			        $pg_code = 'PG1';
			    }
			    else if(strpos($_SESSION['deskripsi'], "PG2")){
			        $pg_code = 'PG2';
			    }
			    else if(strpos($_SESSION['deskripsi'], "PG3")){
			        $pg_code = 'PG3';
			    }
				switch($pg_code) {
					case 'PG1':
					...
					case 'PG2':
						...
						$data['PG2_all'] = array(
							'sn_manager' => $this->User_model->get_history_login_all_index("Sub Div Head PG2", "PG2", $tgl),
							'ppic_manager' => $this->User_model->get_history_login_all_index("Dept Head PPICPG2", "PG2", $tgl),
							'fs_manager' => $this->User_model->get_history_login_all_index("Dept Head FS PG2", "PG2", $tgl),
							'kawil_5' => $this->User_model->get_history_login_all_index("Kawil 5", "W05", $tgl),
							'kawil_6' => $this->User_model->get_history_login_all_index("Kawil 6", "W06", $tgl),
							'kawil_7' => $this->User_model->get_history_login_all_index("Kawil 7", "W07", $tgl),
