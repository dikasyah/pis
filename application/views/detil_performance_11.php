...
<?php
  $row_num = 0;
  foreach($performance['quality']['land_preparation'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
<?php
  $row_num = 0;
  foreach($performance['quality']['fertilization'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>HPT</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quality']['hpt'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Weed</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quality']['weed'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Material</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quality']['material'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
                            ...
                            <div class="col-md-12">
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Direct Cost (NSFC)</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['direct_cost_nsfc'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Direct Cost (NSSC)</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['direct_cost_nssc'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
