...
<script>
  function pindah_tanggal(){
    ...
    window.location.href="/PIS/index.php/HPP_Total_Lokasi/activity_detail?lokasi=<?php echo $produksi['lokasi']; ?>&tgl="+tanggal+"&page=<?php echo $page; ?>&ec=ZN05&subpage=SPSP";
  }
