...
<div id="wrapper">
  ...
  <ul class="navbar-nav sidebar sidebar-dark accordion toggled" style="background-color:#9F229F;" id="accordionSidebar">
    ...
    <li class="nav-item">
      <a class="nav-link p-1" href="/PIS/index.php/HPP_Total_Dashboard/perlocation_wilayah?wilayah=<?php echo $wilayah; ?>">
        <i class="fas fa-fw fa-globe"></i>
        ...
        <form class="d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
          <div class="input-group">
            <span class="d-none d-sm-inline-block" style="color:black;font-size:14px;"><b>
              <a href="/PIS/index.php/HPP_Total_Dashboard/plantation_group?pg=<?php echo $wilayah_desc['plantation_group']; ?>"><?php echo $wilayah_desc['plantation_group']; ?></a> -
...
?>
              <img class="img-profile rounded-circle" src="/PIS/images/profile/empty-profile.png">
<?php
  }
?>
            </a>
          ...
          <div class="col-lg-2 p-1">
            <div class="card shadow" style="width:100%;">
              <div class="card-header py-0 text-center" style="background-color:#75229F;font-size:14px;">
                <span style="color:white;"><b>Wilayah</b></span>
              </div>
              <div class="card-body" style="padding:0;height:100px;background-color:#9944CC;">
                <br>
                <input type="text" name="wilayah" id="wilayah" class="form-control" placeholder="Lokasi" style="background-color:#9944CC;color:black;text-align:center;font-size:25px;height:50px;" maxlength="3" value="<?php echo $wilayah; ?>"/>
              </div>
            </div>
          </div>
...
<?php
  ...
  foreach($lokasi_all as $l){
    ...
    // }
?>
              <option value="<?php echo $l->lokasi_aktif; ?>" style="color:black;font-weight:bold;background-color:<?php //echo $bgcolor_lokasi; ?>;"><?php echo $l->lokasi_aktif; ?></option>
<?php
  }
?>
            </select>
...
<script>
  ...
  function select_main_filter(change){
    ...
    if(change == 1){
      window.location.href="/PIS/index.php/HPP_Total_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&bulan="+bulan+"&element_cost="+element_cost;
    }
    else{
      window.location.href="/PIS/index.php/HPP_Total_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&element_cost="+element_cost;
    }
  }
  function pindah_lokasi(){
    window.location.href="/PIS/index.php/HPP_Total_Lokasi/lokasi?lokasi="+$('#select_lokasi').val();
  }
