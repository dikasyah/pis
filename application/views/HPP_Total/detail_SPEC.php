...
<script>
  function pindah_element_cost(){
    ...
    window.location.href="/PIS/index.php/HPP_Total_Lokasi/activity_detail?lokasi=<?php echo $produksi['lokasi']; ?>&ec="+code_element_cost+"&page=<?php echo $page; ?>&subpage=SPEC";
  }
