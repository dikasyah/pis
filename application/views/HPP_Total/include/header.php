...
<html lang="en">
  <head>
    ...
    <title>PIS - Finished Harvest</title>
    ...
    <style>
      ...
      .table_hpp tr:nth-child(odd){background-color: #DCDCDC;}
      }
    </style>
  </head>
  ...
  function format_nama_ec($ec){
    if($ec == NULL){
      ...
      switch ($ec) {
        ...
        break;
        case 'ZN02':
          return "Seedling Allocation";
        break;
        case 'ZN03':
          return "Planting";
        break;
        case 'ZN04':
          return "Road & Drainage";
        break;
        case 'ZN05':
        ...
        break;
        case 'ZN13':
          return "Irrigation / Springkle";
        break;
        case 'ZN14':
          return "Guard / Pull / Labour";
        break;
        case 'ZN15':
          return "Others";
        break;
