          ...
          <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#228B22;">
              <div class="panel-title-box" style="margin-top:10px;">
                <h2 style="color:white;" id="header_pg"><b><?php echo $pg['nama']; ?></b></h2>
              </div>
...
<?php
  ...
  // }
  //die(($group_cost['Labour'] + $group_cost['Charge'] + $group_cost['Material'] + $group_cost['Bibit']) / $luas_tonase['total']['luas']);
            ...
            <div id='profile' class="panel panel-default" style="height: 350px;">
              <div class="panel-heading" style="background-color:#FF4500;">
                <div class="panel-title-box">
                  <h3 style="color:white;">Profile <?php if($pg != NULL) echo $pg['nama']; else echo "All PG" ?></h3>
                </div>
              </div>
              <div class="panel-body padding" align="center">
                <b>
                  SENIOR MANAGER<br /><?php if($pg != NULL) echo $pg['senior_manager']; else echo "-"; ?><br /><br />
                  MANAGER PQPI<br /><?php if($pg != NULL) echo $pg['manager_pqpi']; else echo "-"; ?><br /><br />
                  MANAGER FS<br /><?php if($pg != NULL) echo $pg['manager_fs']; else echo "-"; ?><br /><br />
                </b>
                <br />
<?php
...
<?php
  ...
  if($_SESSION['crud'] == '1' || $_SESSION['crud'] == '0'){
?>
                <div class='col-md-6' style="padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;">
                  <button class="btn btn-default btn-block" onclick="main_menu();"><i class="fa fa-home"></i> Home</button>
                </div>
                ...
                <div class='col-md-6' style="padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;">
                  <button class="btn btn-default btn-block" onclick="back();"><i class="fa fa-arrow-left"></i> Back</button>
                </div>
                <div class='col-md-6' style="padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;">
                  <button class="btn btn-default btn-block" onclick="perlocation();"><i class="fa fa-list"></i> PerLocation</button>
                </div>
...
?>
                <select class="form-control select" name="select_pg" id="select_pg" onchange="javascript:pindah_pg();">
                  <option value="PG" style="color:black;">All PG</option>
<?php
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading" style="background-color:#0000FF;">
                        <div class="panel-title-box">
                          ...
                          <span style="color:white;"><b><?php echo $pg['code']; ?></b></span>
                        </div>
                        <ul class="panel-controls" style="margin-top: 2px;width:50%;">
                          <select class="form-control select" name="select_category" id="select_category" onchange="sort_performance()">
...
<?php
  ...
  foreach ($wilayah as $w) {
    if($i == 0){
      $nama_wilyah = "'$w->code'";
      $excellent_com_rp_per_ha = (round($performance_wilayah[$w->code]['Excellent_rp_per_ha'] / $performance_wilayah[$w->code]['Total'] * 100));
      $good_com_rp_per_ha = (round($performance_wilayah[$w->code]['Good_rp_per_ha'] / $performance_wilayah[$w->code]['Total'] * 100));
      $poor_com_rp_per_ha = (round($performance_wilayah[$w->code]['Poor_rp_per_ha'] / $performance_wilayah[$w->code]['Total'] * 100));
    }
    else{
      $nama_wilyah .= ", '$w->code'";
      $excellent_com_rp_per_ha .= ', '.(round($performance_wilayah[$w->code]['Excellent_rp_per_ha'] / $performance_wilayah[$w->code]['Total'] * 100));
  ...
  foreach ($wilayah as $w) {
    if($i == 0){
      $nama_wilyah = "'$w->code'";
      $excellent_com_rp_per_kg = (round($performance_wilayah[$w->code]['Excellent_rp_per_kg'] / $performance_wilayah[$w->code]['Total'] * 100));
      $good_com_rp_per_kg = (round($performance_wilayah[$w->code]['Good_rp_per_kg'] / $performance_wilayah[$w->code]['Total'] * 100));
      $poor_com_rp_per_kg = (round($performance_wilayah[$w->code]['Poor_rp_per_kg'] / $performance_wilayah[$w->code]['Total'] * 100));
    }
    else{
      $nama_wilyah .= ", '$w->code'";
      $excellent_com_rp_per_kg .= ', '.(round($performance_wilayah[$w->code]['Excellent_rp_per_kg'] / $performance_wilayah[$w->code]['Total'] * 100));
  ...
  //T0
  $excellent_com_rp_per_ha_t0 = '';
  $good_com_rp_per_ha_t0 = '';
  $poor_com_rp_per_ha_t0 = '';
  $i = 0;
  foreach ($wilayah as $w) {
    if($performance_wilayah_t0[$w->code]['Total'] != 0){
      if($i == 0){
        $nama_wilyah = "'$w->code'";
        $excellent_com_rp_per_ha_t0 = (round($performance_wilayah_t0[$w->code]['Excellent_rp_per_ha'] / $performance_wilayah_t0[$w->code]['Total'] * 100));
        $good_com_rp_per_ha_t0 = (round($performance_wilayah_t0[$w->code]['Good_rp_per_ha'] / $performance_wilayah_t0[$w->code]['Total'] * 100));
        $poor_com_rp_per_ha_t0 = (round($performance_wilayah_t0[$w->code]['Poor_rp_per_ha'] / $performance_wilayah_t0[$w->code]['Total'] * 100));
      }
      else{
        $nama_wilyah .= ", '$w->code'";
        $excellent_com_rp_per_ha_t0 .= ', '.(round($performance_wilayah_t0[$w->code]['Excellent_rp_per_ha'] / $performance_wilayah_t0[$w->code]['Total'] * 100));
      ...
      if($i == 0){
        $nama_wilyah = "'$w->code'";
        $excellent_com_rp_per_ha_t0 = (round(0));
        $good_com_rp_per_ha_t0 = (round(0));
        $poor_com_rp_per_ha_t0 = (round(0));
      }
      else{
        $nama_wilyah .= ", '$w->code'";
        $excellent_com_rp_per_ha_t0 .= ', '.(round(0));
  ...
  $excellent_com_rp_per_kg_t0 = '';
  $good_com_rp_per_kg_t0 = '';
  $poor_com_rp_per_kg_t0 = '';
  $i = 0;
  foreach ($wilayah as $w) {
    if($performance_wilayah_t0[$w->code]['Total'] != 0){
      if($i == 0){
        $nama_wilyah = "'$w->code'";
        $excellent_com_rp_per_kg_t0 = (round($performance_wilayah_t0[$w->code]['Excellent_rp_per_kg'] / $performance_wilayah_t0[$w->code]['Total'] * 100));
        $good_com_rp_per_kg_t0 = (round($performance_wilayah_t0[$w->code]['Good_rp_per_kg'] / $performance_wilayah_t0[$w->code]['Total'] * 100));
        $poor_com_rp_per_kg_t0 = (round($performance_wilayah_t0[$w->code]['Poor_rp_per_kg'] / $performance_wilayah_t0[$w->code]['Total'] * 100));
      }
      else{
        $nama_wilyah .= ", '$w->code'";
        $excellent_com_rp_per_kg_t0 .= ', '.(round($performance_wilayah_t0[$w->code]['Excellent_rp_per_kg'] / $performance_wilayah_t0[$w->code]['Total'] * 100));
      ...
      if($i == 0){
        $nama_wilyah = "'$w->code'";
        $excellent_com_rp_per_kg_t0 = (round(0));
        $good_com_rp_per_kg_t0 = (round(0));
        $poor_com_rp_per_kg_t0 = (round(0));
      }
      else{
        $nama_wilyah .= ", '$w->code'";
        $excellent_com_rp_per_kg_t0 .= ', '.(round(0));
  ...
  //T1
  $excellent_com_rp_per_ha_t1 = '';
  $good_com_rp_per_ha_t1 = '';
  $poor_com_rp_per_ha_t1 = '';
  $i = 0;
  foreach ($wilayah as $w) {
    if($i == 0){
      $nama_wilyah = "'$w->code'";
      $excellent_com_rp_per_ha_t1 = (round($performance_wilayah_t1[$w->code]['Excellent_rp_per_ha'] / $performance_wilayah_t1[$w->code]['Total'] * 100));
      $good_com_rp_per_ha_t1 = (round($performance_wilayah_t1[$w->code]['Good_rp_per_ha'] / $performance_wilayah_t1[$w->code]['Total'] * 100));
      $poor_com_rp_per_ha_t1 = (round($performance_wilayah_t1[$w->code]['Poor_rp_per_ha'] / $performance_wilayah_t1[$w->code]['Total'] * 100));
    }
    else{
      $nama_wilyah .= ", '$w->code'";
      $excellent_com_rp_per_ha_t1 .= ', '.(round($performance_wilayah_t1[$w->code]['Excellent_rp_per_ha'] / $performance_wilayah_t1[$w->code]['Total'] * 100));
  ...
  $excellent_com_rp_per_kg_t1 = '';
  $good_com_rp_per_kg_t1 = '';
  $poor_com_rp_per_kg_t1 = '';
  $i = 0;
  foreach ($wilayah as $w) {
    if($i == 0){
      $nama_wilyah = "'$w->code'";
      $excellent_com_rp_per_kg_t1 = (round($performance_wilayah_t1[$w->code]['Excellent_rp_per_kg'] / $performance_wilayah_t1[$w->code]['Total'] * 100));
      $good_com_rp_per_kg_t1 = (round($performance_wilayah_t1[$w->code]['Good_rp_per_kg'] / $performance_wilayah_t1[$w->code]['Total'] * 100));
      $poor_com_rp_per_kg_t1 = (round($performance_wilayah_t1[$w->code]['Poor_rp_per_kg'] / $performance_wilayah_t1[$w->code]['Total'] * 100));
    }
    else{
      $nama_wilyah .= ", '$w->code'";
      $excellent_com_rp_per_kg_t1 .= ', '.(round($performance_wilayah_t1[$w->code]['Excellent_rp_per_kg'] / $performance_wilayah_t1[$w->code]['Total'] * 100));
...
?>
                          <div style="display:none;" id="bar_comparison_ha">
                            <canvas id="diagram_performance_comparison_ha" height="280px"></canvas>
<script>
	var config_performance_comparison_ha = {
    type: 'bar',
    data: {
  		labels: [
        <?php echo $nama_wilyah; ?>
      ],
  		datasets: [{
        label: 'Excellent',
        ...
        borderWidth: 1,
        data: [
          <?php echo $excellent_com_rp_per_ha; ?>
        ]
        }, {
        label: 'Good',
          ...
          Chart.helpers.each(this.data.datasets.forEach(function (dataset, i) {
            ...
            Chart.helpers.each(meta.data.forEach(function (bar, index) {
              ctx.fillText(dataset.data[index] + '%', bar._model.x, bar._model.y - 10);
                          ...
                          <div style="display:none;" id="bar_comparison_kg">
                            <canvas id="diagram_performance_comparison_kg" height="280px"></canvas>
  <script>
  var config_performance_comparison_kg = {
    type: 'bar',
    data: {
      labels: [
        <?php echo $nama_wilyah; ?>
      ...
      datasets: [{
        ...
        borderWidth: 1,
        data: [
          <?php echo $excellent_com_rp_per_kg; ?>
        ]
        }, {
        label: 'Good',
        backgroundColor: '#FFA500',
          ...
          Chart.helpers.each(this.data.datasets.forEach(function (dataset, i) {
            ...
            Chart.helpers.each(meta.data.forEach(function (bar, index) {
              ctx.fillText(dataset.data[index] + '%', bar._model.x, bar._model.y - 10);
                          ...
                          <div style="display:none;" id="bar_comparison_ha_t0">
                            <canvas id="diagram_performance_comparison_ha_t0" height="280px"></canvas>
<script>
	var config_performance_comparison_ha_t0 = {
    type: 'bar',
    data: {
  		labels: [
        <?php echo $nama_wilyah; ?>
        ...
        borderWidth: 1,
        data: [
          <?php echo $excellent_com_rp_per_ha_t0; ?>
        ]
        }, {
        label: 'Good',
        backgroundColor: '#FFA500',
        ...
        borderWidth: 1,
        data: [
          <?php echo $good_com_rp_per_ha_t0; ?>
        ]
        }, {
        label: 'Poor',
        backgroundColor: '#FF0000',
        ...
        borderWidth: 1,
        data: [
          <?php echo $poor_com_rp_per_ha_t0; ?>
        ]
      }]
    },
    options: {
          ...
          Chart.helpers.each(this.data.datasets.forEach(function (dataset, i) {
            ...
            Chart.helpers.each(meta.data.forEach(function (bar, index) {
              ctx.fillText(dataset.data[index] + '%', bar._model.x, bar._model.y - 10);
                          ...
                          <div style="display:none;" id="bar_comparison_kg_t0">
                            <canvas id="diagram_performance_comparison_kg_t0" height="280px"></canvas>
  <script>
  var config_performance_comparison_kg_t0 = {
    type: 'bar',
    data: {
      labels: [
        <?php echo $nama_wilyah; ?>
      ...
      datasets: [{
        ...
        borderWidth: 1,
        data: [
          <?php echo $excellent_com_rp_per_kg_t0; ?>
        ]
        }, {
        label: 'Good',
        backgroundColor: '#FFA500',
        ...
        borderWidth: 1,
        data: [
          <?php echo $good_com_rp_per_kg_t0; ?>
        ]
        }, {
        label: 'Poor',
        backgroundColor: '#FF0000',
        ...
        borderWidth: 1,
        data: [
          <?php echo $poor_com_rp_per_kg_t0; ?>
        ]
      }]
    },
    options: {
          ...
          Chart.helpers.each(this.data.datasets.forEach(function (dataset, i) {
            ...
            Chart.helpers.each(meta.data.forEach(function (bar, index) {
              ctx.fillText(dataset.data[index] + '%', bar._model.x, bar._model.y - 10);
                          ...
                          <div style="display:none;" id="bar_comparison_ha_t1">
                            <canvas id="diagram_performance_comparison_ha_t1" height="280px"></canvas>
<script>
	var config_performance_comparison_ha_t1 = {
    type: 'bar',
    data: {
  		labels: [
        <?php echo $nama_wilyah; ?>
        ...
        borderWidth: 1,
        data: [
          <?php echo $excellent_com_rp_per_ha_t1; ?>
        ]
        }, {
        label: 'Good',
        backgroundColor: '#FFA500',
        ...
        borderWidth: 1,
        data: [
          <?php echo $good_com_rp_per_ha_t1; ?>
        ]
        }, {
        label: 'Poor',
        backgroundColor: '#FF0000',
        ...
        borderWidth: 1,
        data: [
          <?php echo $poor_com_rp_per_ha_t1; ?>
        ]
      }]
    },
    options: {
          ...
          Chart.helpers.each(this.data.datasets.forEach(function (dataset, i) {
            ...
            Chart.helpers.each(meta.data.forEach(function (bar, index) {
              ctx.fillText(dataset.data[index] + '%', bar._model.x, bar._model.y - 10);
                          ...
                          <div style="display:none;" id="bar_comparison_kg_t1">
                            <canvas id="diagram_performance_comparison_kg_t1" height="280px"></canvas>
  <script>
  var config_performance_comparison_kg_t1 = {
    type: 'bar',
    data: {
      labels: [
        <?php echo $nama_wilyah; ?>
      ...
      datasets: [{
        ...
        borderWidth: 1,
        data: [
          <?php echo $excellent_com_rp_per_kg_t1; ?>
        ]
        }, {
        label: 'Good',
        backgroundColor: '#FFA500',
        ...
        borderWidth: 1,
        data: [
          <?php echo $good_com_rp_per_kg_t1; ?>
        ]
        }, {
        label: 'Poor',
        backgroundColor: '#FF0000',
        ...
        borderWidth: 1,
        data: [
          <?php echo $poor_com_rp_per_kg_t1; ?>
        ]
      }]
    },
    options: {
...
<?php
  $luas_nsfc = round((($luas_tonase['NSFC']['luas']) / ($luas_tonase['NSFC']['luas'] + $luas_tonase['NSSC']['luas'])) * 100);
  $luas_nssc = round((($luas_tonase['NSSC']['luas']) / ($luas_tonase['NSFC']['luas'] + $luas_tonase['NSSC']['luas'])) * 100);
...
?>
                          <tr class='Min' >
                            <td style="padding-top:3px;padding-bottom:3px;" align="center"><a href='/PIS/dashboard/lokasi?lokasi=<?php echo $rmin->lokasi; ?>'><?php echo $rmin->lokasi; ?><a/></td>
                          </tr>
<?php
  }
...
?>
                          <tr class='Max'>
                            <td style="padding-top:3px;padding-bottom:3px;" align="center"><a href='/PIS/dashboard/lokasi?lokasi=<?php echo $rmax->lokasi; ?>'><?php echo $rmax->lokasi; ?><a/></td>
                          </tr>
<?php
  }
?>
...
<script>
  $( document ).ready(function() {
    ...
    if(screen.width <= 768){
      ...
      document.getElementById("header_pg").innerHTML = "<b><?php echo $pg['code']; ?></b>";
    }
    else{
      $(".div-mobile").hide();
      $(".div-leptop").show();
  ...
  function sort_performance(){
    if($("#select_category").val() == 1 && $("#select_satuan").val() == 1){
      if($("#select_tahun_peta").val() == "T"){
        ...
        $("#bar_comparison_ha").hide();
        $("#bar_comparison_kg").hide();
        $("#bar_comparison_ha_t0").hide();
        $("#bar_comparison_kg_t0").hide();
        $("#bar_comparison_ha_t1").hide();
        $("#bar_comparison_kg_t1").hide();
      }
    ...
    else if($("#select_category").val() == 1 && $("#select_satuan").val() == 2){
      if($("#select_tahun_peta").val() == "T"){
        $("#pie_total_ha").hide();
        $("#pie_total_kg").show();
        $("#pie_total_ha_t0").hide();
    ...
    else if($("#select_category").val() == 2 && $("#select_satuan").val() == 1){
      if($("#select_tahun_peta").val() == "T"){
        $("#pie_total_ha").hide();
        $("#pie_total_kg").hide();
        $("#pie_total_ha_t0").hide();
  ...
  function sort_raport(){
    ...
    location.href = "/PIS/dashboard/plantation_group?pg=<?php echo $pg['code']; ?>&status=" + status + "&bulan=" + bulan + "&tahun=" + tahun + "&charge=" + charge;
  }
  ...
  function perlocation(){
    window.location.href="/PIS/dashboard/perlocationpg?pg=<?php echo $pg['code']; ?>";
  }
  function pindah_pg(){
  ...
  window.onload = function() {
    ...
    var ctx_performance_comparison_ha = document.getElementById('diagram_performance_comparison_ha').getContext('2d');
    window.myPie = new Chart(ctx_performance_comparison_ha, config_performance_comparison_ha);
    var ctx_performance_comparison_kg = document.getElementById('diagram_performance_comparison_kg').getContext('2d');
    window.myPie = new Chart(ctx_performance_comparison_kg, config_performance_comparison_kg);
    //T0
    ...
    var ctx_performance_comparison_ha_t0 = document.getElementById('diagram_performance_comparison_ha_t0').getContext('2d');
    window.myPie = new Chart(ctx_performance_comparison_ha_t0, config_performance_comparison_ha_t0);
    var ctx_performance_comparison_kg_t0 = document.getElementById('diagram_performance_comparison_kg_t0').getContext('2d');
    window.myPie = new Chart(ctx_performance_comparison_kg_t0, config_performance_comparison_kg_t0);
    //T1
    ...
    var ctx_performance_comparison_ha_t1 = document.getElementById('diagram_performance_comparison_ha_t1').getContext('2d');
    window.myPie = new Chart(ctx_performance_comparison_ha_t1, config_performance_comparison_ha_t1);
    var ctx_performance_comparison_kg_t1 = document.getElementById('diagram_performance_comparison_kg_t1').getContext('2d');
    window.myPie = new Chart(ctx_performance_comparison_kg_t1, config_performance_comparison_kg_t1);
