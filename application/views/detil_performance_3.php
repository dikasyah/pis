...
<?php
  $row_num = 0;
  foreach($performance['quantity']['yield_nsfc'] as $q1){
    if($row_num % 2 == 0){
...
<?php
  $row_num = 0;
  foreach($performance['quantity']['yield_nssc'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Fertilizer Program</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quantity']['fertilizer_program'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Pineapple Stem</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quantity']['pineapple_stem'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>% RC</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quantity']['rc'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
<?php
  $row_num = 0;
  foreach($performance['quality']['big_fruit'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
<?php
  $row_num = 0;
  foreach($performance['quality']['reject_fruit'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Planting Area Acc</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quality']['planting_area_acc'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Tonnage Acc</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quality']['tonnage_acc'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Material Plan Acc</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quality']['material_plan_acc'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Land Preparation Acc</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quality']['land_preparation_acc'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
                            ...
                            <div class="col-md-12">
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Land Preparation</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['land_preparation'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Planting</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['planting'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Fertilization</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['fertilization'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Weeding</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['weeding'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Irrigation</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['irrigation'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Harvesting</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['harvesting'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Poor Quality</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['poor_quality'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Capex</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['capex'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Opex</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['opex'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
                            ...
                            <div class="col-md-12">
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>5R</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['mutu']['5r'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Six Sigma</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['mutu']['six_sigma'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
