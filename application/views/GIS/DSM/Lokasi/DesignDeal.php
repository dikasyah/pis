...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row ">
				<div class="col-sm-6">
					<h1 class="m-0 float-sm-left">Design Deal</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Dashboard</a></li>
						<li class="breadcrumb-item active">Design Deal</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
...
<div class="modal fade" id="pictModal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="title-pop" id="pictPopTitle">Design Deal</div>
...
<script src="<?php echo base_url('/assets/js/chart_gis/dd_control.js');?>"></script>
