...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row ">
				<div class="col-sm-6">
					<h1 class="m-0 float-sm-left">RGB</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Dashboard</a></li>
						<li class="breadcrumb-item active">RGB</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
...
<div class="modal fade" id="pictModal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="title-pop" id="pictPopTitle">RGB</div>
...
<script src="<?php echo base_url('/assets/js/chart_gis/rgb_control.js');?>"></script>
