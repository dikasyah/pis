					...
					<div class="row gis-card-padding-leftside">
						<div class="card full-wdith">
							<div class="card-header  py-0 pict-header">
								<span id="Title" class="submenu-main-title-gis">Temperature</span>
								<span id="pictDate" class="submenu-main-title-gis"><?php echo isset($picts[0]->date) ? $picts[0]->date : '-'; ?></span>
								<span class="header-blank-space">Temperature</span>
							</div>
						...
						<div class="card full-wdith">
                            ...
                            <table class=" mb-0" style="border: none;height:367px;width:100%">
                                            ...
                                            <tbody id="legendOutput">
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;" width="40px"><div style="width:100%;height:100%;background-color: #940000;"></div></td>
													<td style="font-size:12px; padding:3px; padding-left:20px; font-weight:500; text-align:left">>35 Derajat C</td>
												...
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;"><div style="width:100%;height:100%;background-color: #C70042;"></div></td>
													<td style="font-size:12px; padding:3px; padding-left:20px; font-weight:500; text-align:left">32 - 34 Derajat C</td>
													<td style="font-size:12px; padding:3px; font-weight:500; color:#000; text-align:center;" id="val2">XXX</td>
													<td style="font-size:12px; padding:3px; font-weight:500; color:#000; text-align:center;">Ha</td>
												</tr>
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;"><div style="width:100%;height:100%;background-color: #D84901;"></div></td>
													<td style="font-size:12px; padding:3px; padding-left:20px; font-weight:500; text-align:left">29 -31 Derajat C</td>
													<td style="font-size:12px; padding:3px; font-weight:500; color:#000; text-align:center;" id="val3">XXX</td>
													<td style="font-size:12px; padding:3px; font-weight:500; color:#000; text-align:center;">Ha</td>
												</tr>
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;"><div style="width:100%;height:100%;background-color: #F08A45;"></div></td>
													<td style="font-size:12px; padding:3px; padding-left:20px; font-weight:500; text-align:left">26 - 28 Derajat C</td>
													<td style="font-size:12px; padding:3px; font-weight:500; color:#000; text-align:center;" id="val4">XXX</td>
													<td style="font-size:12px; padding:3px; font-weight:500; color:#000; text-align:center;">Ha</td>
                                                </tr>
                                                <tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;"><div style="width:100%;height:100%;background-color: #FF6701;"></div></td>
													<td style="font-size:12px; padding:3px; padding-left:20px; font-weight:500; text-align:left"> &lt;26 Derajat C </td>
	...
	<div class="pop" id="pictModal">
        <div class="modal-header">
			...
			<div class="pop-header-text-container">
				<div class="title-pop" id="pictPopTitle">Temperature</div>
...
<script>
    ...
    $("#Sen3").removeClass('inactive');
	$("#Sen3").addClass('active');
	$('.select2').select2();
	if (currLoc != "") {
	...
	if(pageDate != ""){
		$("#myCurrPictselector").val("<?php echo isset($picts[0]->date) ? $picts[0]->date.'&'.$picts[0]->location.'&'.$picts[0]->jenis.'&'.$picts[0]->kategori.'&'.$picts[0]->photo_id : "" ?>");	
	}
</script>
<script>
...
var data5 = [37, 8, 21, 23, 33, 43, 23, 45, 21, 33, 41, 32, 50]
var mydata = {
	labels: xAxes,
	datasets: [{
				label: ' C >35 Derajat C',
				...
				label: '29 - 31 Derajat C',
				backgroundColor: '#D84901',
				data: data3,
				lineTension: 0,
				datalabels: {
					color: "#000",
				...
				label: '26 - 28 Derajat C',
				backgroundColor: '#C70042',
				data: data2,
				lineTension: 0,
				datalabels: {
					color: "#000",
...
var mydata2 = {
	labels: ['>35 Derajat C','32 - 34 Derajat C','29 -31 Derajat C','26 - 28 Derajat C', '<26 Derajat C'],
		datasets: [{
		label:'points',
		data: [50, 100, 850, 0, 0],
		datalabels: {
