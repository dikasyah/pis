                ...
                <div class="card full-wdith" >
					...
					<div class="card-body p-0">
						<div class="table-responsive">
							<table class="table table-striped mb-0 DSM-table" id="myTableGIS">
								<thead>
									<tr class="center-text" >
										<td style="width:2%">PG</td>
										<td style="width:10%">Wilayah</td>
										<td style="width:10%">Lokasi</td>
										<td style="width:10%">Kebun</td>	
										<td style="width:12%">Kawil</td>
										<td style="width:12%">Kasbun</td>
										<td style="width:11%">Foto</td>
...
<script>
    ...
    $("#DSM2").removeClass('inactive');
	$("#DSM2").addClass('active');
	$('.select2').select2();
	if (currLoc != "") {
