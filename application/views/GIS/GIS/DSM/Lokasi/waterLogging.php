					...
					<div class="row gis-card-padding-leftside">
						<div class="card full-wdith">
							<div class="card-header  py-0 pict-header">
								<span class="submenu-main-title-gis">Water Logging</span>
								<span id="pictDate" class="submenu-main-title-gis"><?php echo isset($picts[0]->date) ? $picts[0]->date : '-'; ?></span>
								<span class="header-blank-space">Water Logging</span>
							</div>
							...
							<div class="card-body  p-2" >
										<table class=" mb-0" style="border: none;height:367px;width:100%">
                                            ...
                                            <tbody id="legendOutput">
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;" width="40px"><div style="width:100%;height:100%;background-color: #FFFF01;"></div></td>
												...
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;"><div style="width:100%;height:100%;background-color: #1C8D00;"></div></td>
													<td style="font-size:12px; padding:3px; padding-left:20px; font-weight:500; text-align:left">Very Wet</td>
													<td style="font-size:12px; padding:3px; font-weight:500; color:#000; text-align:center;" id="val4">XXX</td>
													<td style="font-size:12px; padding:3px; font-weight:500; color:#000; text-align:center;">Ha</td>
												</tr>
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;"><div style="width:100%;height:100%;background-color: #0434F6;"></div></td>
													<td style="font-size:12px; padding:3px; padding-left:20px; font-weight:500; text-align:left">Flood</td>
...
<script>
    ...
    $("#DSM3").removeClass('inactive');
	$("#DSM3").addClass('active');
	$('.select2').select2();
	if (currLoc != "") {
...
waterLoggingData = [parseFloat(currData[0].Dry), parseFloat(currData[0].Moist), parseFloat(currData[0].Wet), parseFloat(currData[0].Very_Wet), parseFloat(currData[0].Flood)];
var mydata2 = {
