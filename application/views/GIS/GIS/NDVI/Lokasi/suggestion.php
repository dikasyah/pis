			...
			<div class="row px-4 pt-2" >
                <div class="card full-wdith" >
					<div class="card-header  py-0 center-text">
						<span class="submenu-main-title-gis">Suggestion</span>
						
				    </div>
					<div class="card-body p-0" style="width:100%; height:655px;">
						<!-- <div class="pict-overlay-type2" id="pictOverlayGis">
									
						</div>
						<img src="<?php echo base_url()?>/assets/images/placeholderGis.jpg" style="width:100%; height:655px;"> -->
					</div>
				</div>
			</div>
	...
	<div class="pop" id="pictModal">
        <div class="modal-header">
			...
			<div class="pop-header-text-container">
				<div class="title-pop" id="pictPopTitle">Suggestion</div>
...
<script>
    ...
    $("#NDVI4").removeClass('inactive');
	$("#NDVI4").addClass('active');
