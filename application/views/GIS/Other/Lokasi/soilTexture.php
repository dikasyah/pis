					...
					<div class="row gis-card-padding-leftside">
						<div class="card full-wdith">
							<div class="card-header  py-0 pict-header">
								<span class="submenu-main-title-gis">Soil Texture</span>
								<span id="pictDate" class="submenu-main-title-gis"><?php echo isset($picts[0]->date) ? $picts[0]->date : '-'; ?></span>
								<span class="header-blank-space">Soil Texture</span>
							</div>
							...
							<div class="card-body  p-2" >
										<table class=" mb-0" style="border: none;height:367px;width:100%">
                                            ...
                                            <tbody id="legendOutput">
												...
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;"><div style="width:100%;height:100%;background-color: #FFEF01;"></div></td>
												...
												<tr>
													<td style="padding:0;padding-top:0; padding-bottom:0;"><div style="width:100%;height:100%;background-color: #FFA301;"></div></td>
	...
	<div class="pop" id="pictModal">
        <div class="modal-header">
			...
			<div class="pop-header-text-container">
				<div class="title-pop" id="pictPopTitle">Soil Texture</div>
