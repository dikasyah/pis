			...
			<div class="row px-4 pt-2">
				<div class="card full-wdith" >
					<div class="card-header  center-text">
						<span id="Title" class="submenu-main-title-gis">Level Of Greennes</span>
					</div>
					<div class="card-body " >
						<div class="table-responsive" >
							<table class="table table-striped mb-0 LOG-table" id="myTableGIS" style="height:40%!important;" >
								<thead>
