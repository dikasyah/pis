...
?>
                      <tr style="font-weight:bold;">
                        <td style="color:black;padding-top:2px;padding-bottom:2px;"><a style="color:blue;text-decoration:none;" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=AC&wilayah=<?php echo $wilayah_desc['code']; ?>&ga=<?php echo $ec->code; ?>"><?php echo $ec->nama; ?></a></td>
...
<script>
  ...
  function select_main_filter(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&element_cost="+element_cost+"&group_cost="+group_cost+"&group_cost_filter="+group_cost_filter;
  }
