                ...
                <div class="col-lg-12 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Ripening Mekanik</b></span>
                    </div>
                    <div class="card-body" style="padding:0;">
                      <table class="table_pm">
                        <tr class="text-center" style="font-weight:bold;">
                          <td>
<?php
  if($ripening['tgl_realisasi'] != NULL){
    echo ceil((strtotime($ripening['tgl_realisasi']) - strtotime($tgl_panen)) / 86400)." Hari";
  }
  else{
    echo "-";
  }
...
<?php
  if($ripening['tgl_realisasi'] != NULL){
    echo format_tgl($ripening['tgl_realisasi']);
  }
  else{
    echo "-";
  }
?>
                          ...
                          <td><?php echo format_tgl($tgl_panen); ?><br />Harvest</td>
                        </tr>
                      </table>
                    </div>
                  </div>
                ...
                <div class="col-lg-9">
                  <div class="row mb-1">
                    <div class="col-lg-12 p-1">
                      <div class="card shadow" style="width:100%;">
                        <div class="card-header py-0 text-center" style="background-color:#008080;">
                          <span style="color:white;font-size:14px;"><b>Trend Pre Harvesting</b></span>
                        </div>
