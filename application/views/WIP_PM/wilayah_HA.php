              ...
              <div class="card-body" style="padding:0;">
                <table class="table_pm">
                  <tr class="text-center" style="background-color:#008080;font-weight:bold;">
                    <td colspan="6" style="color:white;font-size:14px;padding-top:5px;padding-bottom:5px;"><?php echo format_bln($YEAR_BASE['nilai']); ?> - Harvesting <?php if($tonase != 0) echo round((($harvest_cantergory['Total'] / 1000) / $tonase) * 100); else echo "-"; ?>% Ton</td>
                  </tr>
...
<script>
  ...
  function select_main_filter(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&type="+type+"&category="+category;
  }
