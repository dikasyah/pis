                  ...
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm">
                      <tr style="background-color:#008080;font-weight:bold;">
                        <td style="color:white;">Fungicide : </td>
                        <td>
                          <select class="form-control select" name="select_fungicide" id="select_fungicide" onchange="javascript:select_main_filter();" data-live-search="true">
<?php
  if($fungicide == "Fungicide"){
?>
                            <!-- <option value="Fungicide" style="color:black;" selected>Fungicide</option> -->
<?php
  }
  else{
?>
...
?>
                          <select class="form-control select" name="select_fungicide_2" id="select_fungicide_2" onchange="javascript:select_main_filter();" data-live-search="true" <?php echo $disabled_compare; ?>>
<?php
foreach ($master_material as $mm) {
  if($mm->code == $fungicide_2){
?>
                            <option value="<?php echo $mm->code; ?>" style="color:black;" selected><?php echo $mm->material; ?></option>
<?php
  }
              ...
              <div class="col-lg-12 p-1">
                <div class="card shadow" style="width:100%;">
                  <div class="card-header py-0 text-center" style="background-color:#008080;">
                    <span style="color:white;font-size:14px;"><b>Quantity Fungicide</b></span>
                  </div>
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm">
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Fosetil'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Fosetil']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Metalaxil'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Metalaxil']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Propiconazole'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Propiconazole']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Prochloraz'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Prochloraz']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Mankozeb'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Mankozeb']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Folirfos'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Folirfos']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['H3PO3'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['H3PO3']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Detazeb'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Detazeb']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Sarineb'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Sarineb']; ?></td>
                      </tr>
                      <tr>
<?php
...
?>
                        ...
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Sorento'] / $luas); ?></td>
                        <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Sorento']; ?></td>
                      </tr>
                    </table>
                  </div>
                </div>
              ...
              <div class="col-lg-12 p-1">
                <div class="card shadow" style="width:100%;">
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm">
                      <tr style="background-color:#008080;font-weight:bold;">
                        <td style="color:white;">Sebaran Material : </td>
                        <td>
...
<?php
  foreach ($master_material as $mm) {
    if($mm->material == $sebaran_material){
?>
                            <option value="<?php echo $mm->material; ?>" style="color:black;" selected><?php echo $mm->material; ?></option>
<?php
    }
    else{
?>
                            <option value="<?php echo $mm->material; ?>" style="color:black;"><?php echo $mm->material; ?></option>
<?php
    }
  }
?>
...
<?php
  ...
  $width_sebaran_5 = 0;
  if($sebaran['Total'] != 0){
    if(isset($sebaran['1']['resource'])){
      $width_sebaran_1 = ($sebaran['1']['resource'] / $sebaran['Total']) * 100;
    }
    if(isset($sebaran['2']['resource'])){
      $width_sebaran_2 = ($sebaran['2']['resource'] / $sebaran['Total']) * 100;
    }
    if(isset($sebaran['3']['resource'])){
      $width_sebaran_3 = ($sebaran['3']['resource'] / $sebaran['Total']) * 100;
    }
    if(isset($sebaran['4']['resource'])){
      $width_sebaran_4 = ($sebaran['4']['resource'] / $sebaran['Total']) * 100;
    }
    if(isset($sebaran['5']['resource'])){
      $width_sebaran_5 = ($sebaran['5']['resource'] / $sebaran['Total']) * 100;
    }
?>
                          <tr class="text-center">
                            <td style="background-color:#008000;height:<?php echo $width_sebaran_1; ?>%;"><?php if(isset($sebaran['1']['activity_desc'])) echo $sebaran['1']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_1); ?>%)</td>
                          </tr>
                          <tr class="text-center">
                            <td style="background-color:#9ACD32;height:<?php echo $width_sebaran_2; ?>%;"><?php if(isset($sebaran['2']['activity_desc'])) echo $sebaran['2']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_2); ?>%)</td>
                          </tr>
                          <tr class="text-center">
                            <td style="background-color:#FF8C00;height:<?php echo $width_sebaran_3; ?>%;"><?php if(isset($sebaran['3']['activity_desc'])) echo $sebaran['3']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_3); ?>%)</td>
                          </tr>
                          <tr class="text-center">
                            <td style="background-color:#B22222;height:<?php echo $width_sebaran_4; ?>%;"><?php if(isset($sebaran['4']['activity_desc'])) echo $sebaran['4']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_4); ?>%)</td>
                          </tr>
                          <tr class="text-center">
                            <td style="background-color:#0022FF;height:<?php echo $width_sebaran_5; ?>%;"><?php if(isset($sebaran['5']['activity_desc'])) echo $sebaran['5']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_5); ?>%)</td>
                          </tr>
<?php
    }
    else{
?>
                      <tr class="text-center">
                        <td style="background-color:#008000;height:<?php echo $width_sebaran_1; ?>%;">- (<?php echo angka_ribuan(0); ?>%)</td>
                      </tr>
                      <tr class="text-center">
                        <td style="background-color:#9ACD32;height:<?php echo $width_sebaran_2; ?>%;">- (<?php echo angka_ribuan(0); ?>%)</td>
                      </tr>
                      <tr class="text-center">
                        <td style="background-color:#FF8C00;height:<?php echo $width_sebaran_3; ?>%;">- (<?php echo angka_ribuan(0); ?>%)</td>
                      </tr>
                      <tr class="text-center">
                        <td style="background-color:#B22222;height:<?php echo $width_sebaran_4; ?>%;">- (<?php echo angka_ribuan(0); ?>%)</td>
                      </tr>
                      <tr class="text-center">
                        <td style="background-color:#0022FF;height:<?php echo $width_sebaran_5; ?>%;">- (<?php echo angka_ribuan(0); ?>%)</td>
                      </tr>
<?php
  }
?>
      ...
      animation: {
        ...
        animateRotate: true
          ...
          <div class="col-lg-6 p-1">
            <div class="card shadow" style="width:100%;">
              <div class="card-header py-0 text-center" style="background-color:#008080;">
                <span style="color:white;font-size:14px;"><b>Season</b></span>
              </div>
              <div class="card-body" style="padding:0;">
                <canvas id="diagram_season"></canvas>
<?php
  $season = "";
  if($sebaran_iklim['Total'] != 0){
    $season = round(($sebaran_iklim['S1'] / $sebaran_iklim['Total']) * 100);
    $season .= ", ".round(($sebaran_iklim['S2'] / $sebaran_iklim['Total']) * 100);
    $season .= ", ".round(($sebaran_iklim['S3'] / $sebaran_iklim['Total']) * 100);
    $season .= ", ".round(($sebaran_iklim['S4'] / $sebaran_iklim['Total']) * 100);
    $season .= ", ".round(($sebaran_iklim['S5'] / $sebaran_iklim['Total']) * 100);
  }
  else{
    $season = ", , , ,";
  }
...
<script>
  var config_season = {
    type: 'bar',
    data: {
      labels: ['Sangat Basah', 'Basah', 'Normal', 'Kering', 'Sangat Kering'],
      datasets: [{
        type: 'bar',
        label: 'Season',
        backgroundColor: [
...
<script>
  ...
  function select_main_filter(){
    ...
    var fungicide = $('#select_fungicide').val();
    var type = $('#select_type').val();
    var fungicide_2 = $('#select_fungicide_2').val();
    var compare = $('#select_compare').val();
    var pengamatan = $('#select_pengamatan').val();
    var iaf = $('#select_sebaran').val();
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&fungicide="+fungicide+"&type="+type+"&fungicide_2="+fungicide_2+"&compare="+compare+"&pengamatan="+pengamatan+"&sebaran="+iaf;
  }
  ...
  window.onload = function(){
		...
		var ctx_season = document.getElementById('diagram_season').getContext('2d');
		window.myBar = new Chart(ctx_season, config_season);
	};
</script>
