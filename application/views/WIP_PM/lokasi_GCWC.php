                        ...
                        <div class="card-body" style="padding:0;">
                          <table class="table_pm">
                            <tr class="text-center">
                              ...
                              <td>
                                <h3><?php echo angka_ribuan($weeding_manual['biaya_realisasi'] / ($luas * ceil($weeding_manual['hasil_efektif'] / $luas))); ?></h3>
                              </td>
                            </tr>
                            <tr class="text-center" style="background-color:#008080;font-weight:bold;">
    ...
    options: {
      ...
      // }
                ...
                <div class="col-lg-6 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Trend Weed Control</b></span>
                    </div>
                    <div class="card-body" style="padding-bottom:5px;">
