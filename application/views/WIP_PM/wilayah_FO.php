...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
    ...
    <li class="nav-item">
      <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=BK&wilayah=<?php echo $wilayah; ?>">
        <i class="fas fa-fw fa-globe"></i>
          ...
          <div class="col-lg-4 p-1">
            <div class="card shadow" style="width:100%;">
              <div class="card-body" style="padding:5px;">
                <canvas id="diagram_forcing"></canvas>
<?php
  if($forcing_3['NSFC'] + $forcing_3['NSSC'] + $forcing_3['Others'] != NULL){
    $nsfc = round(($forcing_3['NSFC'] / ($forcing_3['NSFC'] + $forcing_3['NSSC'] + $forcing_3['Others'])) * 100);
    $nssc = round(($forcing_3['NSSC'] / ($forcing_3['NSFC'] + $forcing_3['NSSC'] + $forcing_3['Others'])) * 100);
    $others = round(($forcing_3['Others'] / ($forcing_3['NSFC'] + $forcing_3['NSSC'] + $forcing_3['Others'])) * 100);
  }
  else{
    $nsfc = round((0) * 100);
    $nssc = round((0) * 100);
  ...
  $summary_forcing_3 = $nsfc.', '.$nssc.', '.$others;
?>
<script>
  var config_forcing = {
    type: 'doughnut',
      ...
      animation: {
        ...
        animateRotate: true
          ...
          <div class="col-lg-4 p-1">
            <div class="card shadow" style="width:100%;">
              <div class="card-header py-0 text-center" style="background-color:#008080;">
                <span style="color:white;font-size:14px;"><b>Cost Impact Aplikasi Forcing</b></span>
              </div>
              <div class="card-body" style="padding:0;">
                <table class="table_pm text-center" style="font-weight:bold;">
                  <tr>
                    <td style="padding-top:75px;padding-bottom:75px;background-color:#008000;color:black;" width="25%">F < -2Jt<br /><?php if($akurasi_forcing_cost['AF4'] != NULL) echo $akurasi_forcing_cost['AF4']; else echo "-"; ?> Lokasi</td>
                    <td style="padding-top:75px;padding-bottom:75px;background-color:#0000FF;color:black;" width="25%">-2Jt <= F <= 0<br /><?php if($akurasi_forcing_cost['AF3'] != NULL) echo $akurasi_forcing_cost['AF3']; else echo "-"; ?> Lokasi</td>
                    <td style="padding-top:75px;padding-bottom:75px;background-color:#FFFF00;color:black;" width="25%">0 < F <= 2Jt<br /><?php if($akurasi_forcing_cost['AF2'] != NULL) echo $akurasi_forcing_cost['AF2']; else echo "-"; ?> Lokasi</td>
                    <td style="padding-top:75px;padding-bottom:75px;background-color:#FF0000;color:black;" width="25%">F > 2Jt<br /><?php if($akurasi_forcing_cost['AF1'] != NULL) echo $akurasi_forcing_cost['AF1']; else echo "-"; ?> Lokasi</td>
                  </tr>
                </table>
              </div>
            </div>
        ...
        <div class="row mb-1">
          <div class="col-lg-3 p-1">
            <div class="card-header py-0 text-center" style="background-color:#008080;">
              <span style="color:white;font-size:14px;"><b>Pengamatan % Bunga</b></span>
            </div>
            <div class="card-body" style="padding:0;">
              <table width="100%" style="font-weight:bold;font-size:12px;">
                <tbody>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>Total</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan($PersenBunga['Total']); else echo "-"; ?></td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>Normal</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan($PersenBunga['NTotal']); else echo "-"; ?></td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>Abnormal</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan($PersenBunga['ATotal']); else echo "-"; ?></td>
                  </tr>
                  <!-- <tr>
                    <td style="background-color:#008080;" colspan="2"><hr></td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Bunga</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['PersenBunga'] / $PersenBunga['Lokasi']) * 100); else echo "-"; ?> %</td>
                  </tr> -->
                  <tr>
                    <td style="background-color:#008080;" colspan="2"><hr></td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Bunga Normal N/N</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:red;font-size:13px;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['BNormalNN'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Bunga Normal N/T</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:red;font-size:13px;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['BNormalNT'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="background-color:#008080;" colspan="2"><hr></td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Berbunga Normal</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['BNormal'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Mandul Normal</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['MNormal'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="background-color:#008080;" colspan="2"><hr></td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Bunga Penyakit</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['BPenyakit'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Bunga Kerdil</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['BKerdil'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Mandul Penyakit</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['MPenyakit'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Mandul Kerdil</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['MKerdil'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Bunga Dimakan Tikus</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['BDimakanTikus'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Bunga Buah Alami</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['BBuahAlami'])); else echo "-"; ?> %</td>
                  </tr>
                  <tr>
                    <td style="color:white;background-color:#008080;" width='50%'>% Bunga Sudah Dipanen</td>
                    <td class="text-center" style="padding-top:5px;padding-bottom:5px;color:black;" width='50%'><?php if($PersenBunga['Lokasi'] != 0) echo angka_ribuan_2(($PersenBunga['BSudahDipanen'])); else echo "-"; ?> %</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <div class="card-body" style="padding:0;overflow-x:auto;">
                <table class="table_pm" style="font-weight:bold;">
                  <tr class="text-center" style="background-color:#008080;">
                    <td style="color:white;" colspan="8">Activity</td>
                    <td colspan="3">
                      <select class="form-control select" name="select_forcing" id="select_forcing" style="color:black;font-weight:bold;width:100%;" onchange="select_main_filter()">
<?php
  $option_forcing_1 = "";
  $option_forcing_2 = "";
  $option_forcing_3 = "";
  ...
  switch ($forcing) {
    case '1321111111':
      $option_forcing_1 = "selected";
    break;
    case '1321111315':
      $option_forcing_2 = "selected";
    break;
    case '1321111311':
      $option_forcing_3 = "selected";
    break;
    case '1321111313':
      $option_forcing_4 = "selected";
    break;
    case '1321111515':
      $option_forcing_5 = "selected";
    break;
    case '1321111511':
      $option_forcing_6 = "selected";
    break;
    case '1321131115':
      $option_forcing_7 = "selected";
    break;
    case '1321131315':
      $option_forcing_8 = "selected";
    break;
    case '1321131311':
      $option_forcing_9 = "selected";
    break;
  }
?>
                        <option value="1321111111" <?php echo $option_forcing_1; ?>>Forcing 1</option>
                        <option value="1321111315" <?php echo $option_forcing_2; ?>>Forcing Man 2</option>
                        <option value="1321111311" <?php echo $option_forcing_3; ?>>Forcing Mek 2</option>
                        <option value="1321111313" <?php echo $option_forcing_4; ?>>Forcing Semi Mek 2</option>
                        <option value="1321111515" <?php echo $option_forcing_5; ?>>Forcing Man 3</option>
                        <option value="1321111511" <?php echo $option_forcing_6; ?>>Forcing Mek 3</option>
                        <option value="1321131115" <?php echo $option_forcing_7; ?>>Reforcing 1</option>
                        <option value="1321131315" <?php echo $option_forcing_8; ?>>Reforcing Man 2</option>
                        <option value="1321131311" <?php echo $option_forcing_9; ?>>Reforcing Mek 2</option>
                      </select>
                    </td>
                  </tr>
                  <tr class="text-center" style="background-color:#008080;">
                    ...
                    <td style="color:white;">Akurasi Forcing</td>
                    <td style="color:white;">Cost</td>
                    <td style="color:white;">Urea</td>
                    <td style="color:white;">Borax</td>
                    <td style="color:white;">Ethylene</td>
                    <td style="color:white;">Ethepon</td>
                    <td style="color:white;">Kaolin</td>
                  </tr>
<?php
  $a = 1;
  foreach ($lokasi_forcing as $lf) {
    if($lf->akurasi_forcing == 0){
      $forcing = "On The Track";
    }
    else if($lf->akurasi_forcing < 0){
      $forcing = "Maju ".abs($lf->akurasi_forcing)." Bulan";
    }
    else{
      $forcing = "Mundur ".abs($lf->akurasi_forcing)." Bulan";
    }
?>
                  <tr>
                    <td class="text-right"><?php echo $a; ?></td>
                    <td class="text-center"><a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=<?php echo $lf->lokasi; ?>'><?php echo $lf->lokasi; ?></a></td>
                    <td class="text-center"><?php echo $lf->status; ?></td>
                    <td class="text-center"><?php echo $lf->umur; ?></td>
                    <td class="text-center"><?php echo $forcing; ?></td>
                    <td class="text-center"><?php echo angka_ribuan($lf->Cost); ?></td>
                    <td class="text-center"><?php echo angka_ribuan_2($lf->Urea); ?></td>
                    <td class="text-center"><?php echo angka_ribuan_2($lf->Borax); ?></td>
                    <td class="text-center"><?php echo angka_ribuan_2($lf->Ethylene); ?></td>
                    <td class="text-center"><?php echo angka_ribuan_2($lf->Ethepon); ?></td>
                    <td class="text-center"><?php echo angka_ribuan_2($lf->Kaolin); ?></td>
                  </tr>
<?php
    $a++;
  }
...
<script>
  ...
  function select_main_filter(){
    ...
    var forcing = $('#select_forcing').val();
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&forcing="+forcing;
  }
  function pindah_lokasi(){
    window.location.href="/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi="+$('#select_lokasi').val();
  }
  window.onload = function(){
		var ctx_forcing = document.getElementById('diagram_forcing').getContext('2d');
		window.myBar = new Chart(ctx_forcing, config_forcing);
	};
</script>
