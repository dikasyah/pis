...
<?php
  if($type == 1){
    $type_fungicide_1 = "selected";
    $type_fungicide_2 = "";
  }
  else{
    $type_fungicide_1 = "";
    $type_fungicide_2 = "selected";
  }
?>
                              <option value="1" style="color:black;" <?php echo $type_fungicide_1; ?>>Per-Umur</option>
                              <option value="2" style="color:black;" <?php echo $type_fungicide_2; ?>>Accumulation</option>
                            </select>
                          </td>
                        </tr>
                      </table>
              ...
              <div class="card shadow" style="width:100%;">
                ...
                <div class="card-body" style="padding:0;">
                  <table class="table_pm">
                    ...
                    <tr>
<?php
  if($std_material['Fosetil'] >= ($real_material['Fosetil'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      ...
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Fosetil&page=<?php echo $page; ?>&subpage=SPMA">Fosetil</a></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Fosetil']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Fosetil']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['Metalaxil'] >= ($real_material['Metalaxil'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Metalaxil&page=<?php echo $page; ?>&subpage=SPMA">Metalaxil</a></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Metalaxil']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Metalaxil']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['Propiconazole'] >= ($real_material['Propiconazole'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Propiconazole&page=<?php echo $page; ?>&subpage=SPMA">Propiconazole</a></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Propiconazole']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Propiconazole']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['Prochloraz'] >= ($real_material['Prochloraz'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Prochloraz&page=<?php echo $page; ?>&subpage=SPMA">Prochloraz</a></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Prochloraz']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Prochloraz']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['Mankozeb'] >= ($real_material['Mankozeb'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Mankozeb&page=<?php echo $page; ?>&subpage=SPMA">Mankozeb</a></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Mankozeb']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Mankozeb']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['Folirfos'] >= ($real_material['Folirfos'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Folirfos&page=<?php echo $page; ?>&subpage=SPMA">Folirfos</a></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Folirfos']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Folirfos']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['H3PO3'] >= ($real_material['H3PO3'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=H3PO3&page=<?php echo $page; ?>&subpage=SPMA">H3PO3</a></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['H3PO3']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['H3PO3']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['Detazeb'] >= ($real_material['Detazeb'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Detazeb&page=<?php echo $page; ?>&subpage=SPMA">Detazeb</a></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Detazeb']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Detazeb']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['Sarineb'] >= ($real_material['Sarineb'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Sarineb&page=<?php echo $page; ?>&subpage=SPMA">Sarineb</a></td>
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material['Sarineb']); ?></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Sarineb']); ?></td>
                      <td class="text-left" style="font-weight:bold;"><?php echo $satuan_material['Sarineb']; ?></td>
                    </tr>
                    <tr>
<?php
  if($std_material['Sorento'] >= ($real_material['Sorento'] / $luas)){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  else{
...
?>
                      <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                      <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=Sorento&page=<?php echo $page; ?>&subpage=SPMA">Sorento</a></td>
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material['Sorento']); ?></td>
                      ...
                      <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Sorento']); ?></td>
...
<script>
  ...
  function select_main_filter(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Lokasi/lokasi?page=<?php echo $page; ?>&lokasi="+lokasi+"&fungicide="+fungicide+"&type="+type+"&fungicide_2="+fungicide_2+"&compare="+compare;
  }
