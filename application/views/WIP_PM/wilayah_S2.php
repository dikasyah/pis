                ...
                <div class="col-lg-4 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Harvested Area Proportion</b></span>
                    </div>
                    <div class="card-body" style="padding:0;padding-bottom:5px;">
                      <canvas id="diagram_proporsi_ratun" style="padding:5px;"></canvas>
<?php
  $total_proporsi_ratun = $proporsi_ratun['NSFC'] + $proporsi_ratun['NSSC'];
  if($total_proporsi_ratun != NULL){
    $proporsi = round(($proporsi_ratun['NSFC'] / $total_proporsi_ratun) * 100);
    $proporsi .= ', '.round(($proporsi_ratun['NSSC'] / $total_proporsi_ratun) * 100);
  }
  else{
    $proporsi = '0, 0';
  }
          ...
          gridLines: {
            ...
            drawOnChartArea: false,
                ...
                <div class="col-lg-4 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Lokasi Umur</b></span>
                    </div>
                    <div class="card-body" style="padding:0;">
                      <table class="table_pm text-center" style="font-weight:bold;">
                        <tr>
                          <td style="padding-top:10px;padding-bottom:10px;background-color:#008080;color:white;">lokasi</td>
                          <td style="padding-top:10px;padding-bottom:10px;"><?php if($umur_lokasi['U1'] != NULL) echo $umur_lokasi['U1']; else echo '-'; ?> lokasi</td>
                          <td style="padding-top:10px;padding-bottom:10px;"><?php if($umur_lokasi['U2'] != NULL) echo $umur_lokasi['U2']; else echo '-'; ?> lokasi</td>
                        </tr>
                        <tr>
                          <td style="padding-top:10px;padding-bottom:10px;background-color:#008080;color:white;">Umur</td>
                          <td style="padding-top:10px;padding-bottom:10px;">< 5</td>
                          <td style="padding-top:10px;padding-bottom:10px;">< 10</td>
                        </tr>
                        ...
                        <tr>
                          <td style="padding-top:10px;padding-bottom:10px;background-color:#008080;color:white;">lokasi</td>
                          <td style="padding-top:10px;padding-bottom:10px;"><?php if($umur_lokasi['U3'] != NULL) echo $umur_lokasi['U3']; else echo '-'; ?> lokasi</td>
                          <td style="padding-top:10px;padding-bottom:10px;"><?php if($umur_lokasi['U4'] != NULL) echo $umur_lokasi['U4']; else echo '-'; ?> lokasi</td>
                        </tr>
                        <tr>
                          <td style="padding-top:10px;padding-bottom:10px;background-color:#008080;color:white;">Umur</td>
                          <td style="padding-top:10px;padding-bottom:10px;">< 19</td>
                          <td style="padding-top:10px;padding-bottom:10px;">< 24</td>
                        </tr>
                      </table>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Tonase Proportion</b></span>
                    </div>
                    <div class="card-body" style="padding:0;">
                      <canvas id="diagram_proporsi_tonase"></canvas>
<?php
  if($proporsi_tonase['Tonase'] != 0){
    $NSFC = round(($proporsi_tonase['NSFC'] / $proporsi_tonase['Tonase']) * 100);
    $NSSC = round(($proporsi_tonase['NSSC'] / $proporsi_tonase['Tonase']) * 100);
  }
  else{
    $NSFC = round((0) * 100);
    $NSSC = round((0) * 100);
            ...
            <div class="col-lg-12">
              <div class="row">
                <div class="col-lg-6 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Yield Proportion</b></span>
                    </div>
                    <div class="card-body" style="padding:0;padding-bottom:5px;">
                      <canvas id="diagram_proporsi_yield" style="padding:5px;"></canvas>
<?php
  if($proporsi_yield['Total'] != NULL || $proporsi_yield['Total'] != 0){
    $py = round(($proporsi_yield['T1'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T2'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T3'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T4'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T5'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T6'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T7'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T8'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T9'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T10'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T11'] / $proporsi_yield['Total']) * 100, 2);
    $py .= ', '.round(($proporsi_yield['T12'] / $proporsi_yield['Total']) * 100, 2);
  }
  else{
    $proporsi = ', , , , , , ,';
  }
?>
<script>
  var config_proporsi_yield = {
    type: 'bar',
    data: {
      labels: ['Y > 98', '98 > Y > 95', '95 > Y > 90', '90 > Y > 80', '80 > Y > 70', '70 > Y > 65', '65 > Y > 60', '60 > Y > 55', '55 > Y > 45', '45 > Y > 35', '35 > Y > 25', 'Y < 25'],
      datasets: [{
        type: 'bar',
        label: 'Proporsi',
        backgroundColor: [
                ...
                <div class="col-lg-6 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-body" style="padding:0;">
                      <div class="row">
                        <div class="col-lg-6">
                          <table class="table_pm" style="color:black;font-weight:bold;">
                            <tr class="text-center" style="background-color:#32CD32;">
                              <td colspan="4" style="color:white;">Higher</td>
                            </tr>
                            <tr class="text-center" style="background-color:#32CD32;">
                              <td style="color:white;">Lokasi</td>
                              <td style="color:white;">Status</td>
                              <td style="color:white;">Yield</td>
                              <td style="color:white;">Keterangan</td>
                            </tr>
    <?php
      foreach ($proporsi_yield_lokasi['high'] as $py) {
    ?>
                            <tr class="text-center">
                              <td style="color:black;">
<?php
  if($py->keterangan == 'Rencana'){
?>
                                <a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=<?php echo $py->lokasi; ?>'><?php echo $py->lokasi; ?></a>
<?php
  }
  else{
?>
...
?>
                              ...
                              <td style="color:black;"><?php echo ($py->status); ?></td>
                              <td style="color:black;"><?php echo angka_ribuan_2($py->Yield); ?></td>
                              <td style="color:black;"><?php echo ($py->keterangan); ?></td>
                            </tr>
<?php
  }
?>
                        ...
                        <div class="col-lg-6">
                          <table class="table_pm" style="color:black;font-weight:bold;">
                            <tr class="text-center" style="background-color:#FF1515;">
                              <td colspan="4" style="color:white;">Lower</td>
                            </tr>
                            <tr class="text-center" style="background-color:#FF1515;">
                              <td style="color:white;">Lokasi</td>
                              <td style="color:white;">Status</td>
...
<?php
  foreach ($proporsi_yield_lokasi['low'] as $py) {
?>
                            <tr class="text-center">
                              <td style="color:black;">
<?php
...
<script>
  ...
  function select_main_filter(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur;
  }
  function pindah_lokasi(){
    window.location.href="/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi="+$('#select_lokasi').val();
  }
  window.onload = function(){
    var ctx_proporsi_ratun = document.getElementById('diagram_proporsi_ratun').getContext('2d');
    window.myBar = new Chart(ctx_proporsi_ratun, config_proporsi_ratun);
    var ctx_proporsi_yield = document.getElementById('diagram_proporsi_yield').getContext('2d');
    window.myBar = new Chart(ctx_proporsi_yield, config_proporsi_yield);
    var ctx_proporsi_tonase = document.getElementById('diagram_proporsi_tonase').getContext('2d');
    window.myBar = new Chart(ctx_proporsi_tonase, config_proporsi_tonase);
  }
</script>
