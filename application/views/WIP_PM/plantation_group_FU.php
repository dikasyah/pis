...
<?php
  ...
  if($sebaran['Total'] != 0){
    ...
    if(isset($sebaran['2'])){
      ...
      $width_sebaran_2 = (0 / $sebaran['Total']) * 100;
    }
    if(isset($sebaran['3'])){
      $width_sebaran_2 = ($sebaran['3']['resource'] / $sebaran['Total']) * 100;
    }
    else{
      $width_sebaran_2 = (0 / $sebaran['Total']) * 100;
    }
    if(isset($sebaran['4'])){
      $width_sebaran_2 = ($sebaran['4']['resource'] / $sebaran['Total']) * 100;
    }
    else{
      $width_sebaran_2 = (0 / $sebaran['Total']) * 100;
    }
    if(isset($sebaran['5'])){
      $width_sebaran_2 = ($sebaran['5']['resource'] / $sebaran['Total']) * 100;
    }
    else{
      $width_sebaran_2 = (0 / $sebaran['Total']) * 100;
    }
?>
                      ...
                      <tr class="text-center">
                        <td style="background-color:#9ACD32;height:<?php echo $width_sebaran_2; ?>%;"><?php if(isset($sebaran['2'])) echo $sebaran['2']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_2); ?>%)</td>
                      </tr>
                      <tr class="text-center">
                        <td style="background-color:#FF8C00;height:<?php echo $width_sebaran_3; ?>%;"><?php if(isset($sebaran['3'])) echo $sebaran['3']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_3); ?>%)</td>
                      </tr>
                      <tr class="text-center">
                        <td style="background-color:#B22222;height:<?php echo $width_sebaran_4; ?>%;"><?php if(isset($sebaran['4'])) echo $sebaran['4']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_4); ?>%)</td>
                      </tr>
                      <tr class="text-center">
                        <td style="background-color:#0022FF;height:<?php echo $width_sebaran_5; ?>%;"><?php if(isset($sebaran['5'])) echo $sebaran['5']['activity_desc']; else echo "-"; ?> (<?php echo angka_ribuan($width_sebaran_5); ?>%)</td>
                      </tr>
<?php
    }
    else{
...
<script>
  ...
  function select_main_filter(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?page=<?php echo $page; ?>&pg="+pg+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&fungicide="+fungicide+"&type="+type+"&fungicide_2="+fungicide_2+"&compare="+compare+"&pengamatan="+pengamatan+"&sebaran="+iaf;
  }
