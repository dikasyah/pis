  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link p-1" href="/PIS/WIP_PM_Dashboard">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePG" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white p-1 collapse-inner rounded">
            <a class="collapse-item small p-1" href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?pg=PG1">PG 1</a>
            <a class="collapse-item small p-1" href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?pg=PG2">PG 2</a>
            <a class="collapse-item small p-1" href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?pg=PG3">PG 3</a>
          </div>
        </div>
      </li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <span class="d-none d-sm-inline-block" style="color:black;font-size:16px;"><b>Working in Proccess - Plant Maintenance</b></span>
              <span class="d-sm-none" style="color:black;font-size:12px;"><b>WIP - Plant Maintenance</b></span>
            </div>
          </form>
...
?>
                <option value="All" <?php echo $option_kelas_1; ?>>All</option>
                <option value="B" <?php echo $option_kelas_2; ?>>B</option>
                <option value="S" <?php echo $option_kelas_3; ?>>S</option>
                <option value="K" <?php echo $option_kelas_4; ?>>K</option>
              </select>
            </div>
            <div class="col-lg-2 p-1 text-center">
...
?>
                <option value="<?php echo date('Y', strtotime($YEAR_BASE['nilai'])); ?>" <?php echo $option_tahun_1; ?>><?php echo date('Y', strtotime($YEAR_BASE['nilai'])); ?></option>
                <option value="<?php echo date('Y', strtotime($YEAR_BASE['nilai'])) + 1; ?>" <?php echo $option_tahun_2; ?>><?php echo date('Y', strtotime($YEAR_BASE['nilai'])) + 1; ?></option>
              </select>
            </div>
            <div class="col-lg-2 p-1 text-center">
...
?>
                <option value="Total" <?php echo $option_bulan_1; ?>>Total</option>
                <option value="1" <?php echo $option_bulan_2; ?>>Januari</option>
                <option value="2" <?php echo $option_bulan_3; ?>>Februari</option>
                <option value="3" <?php echo $option_bulan_4; ?>>Maret</option>
                <option value="4" <?php echo $option_bulan_5; ?>>April</option>
                <option value="5" <?php echo $option_bulan_6; ?>>Mei</option>
                <option value="6" <?php echo $option_bulan_7; ?>>Juni</option>
                <option value="7" <?php echo $option_bulan_8; ?>>Juli</option>
                <option value="8" <?php echo $option_bulan_9; ?>>Agustus</option>
                <option value="9" <?php echo $option_bulan_10; ?>>September</option>
                <option value="10" <?php echo $option_bulan_11; ?>>Oktober</option>
                <option value="11" <?php echo $option_bulan_12; ?>>November</option>
                <option value="12" <?php echo $option_bulan_13; ?>>Desember</option>
              </select>
            </div>
            <div class="col-lg-2 p-1 text-center">
              <span style="color:black;font-weight:bold;">Umur</span>
              <select class="form-control select" name="umur" id="umur" style="color:black;font-weight:bold;width:100%;" onchange="select_main_filter()">
<?php
  $option_bulan_1 = "";
  $option_bulan_2 = "";
  $option_bulan_3 = "";
            ...
            <div class="col-md-4">
              <div class="row">
                <div class="card shadow" style="width:100%;">
                  <div class="card-header py-2 text-center" style="background-color:#008080;">
                    <span style="font:14px;color:white;"><b><a style="color:white;text-decoration:none;" href="/PIS/WIP_PM_Dashboard/plantation_group?pg=PG1">PG 1</a></b></span>
                  </div>
          ...
          gridLines: {
            ...
            <div class="col-md-4">
              <div class="row">
                <div class="card shadow" style="width:100%;">
                  <div class="card-header py-2 text-center" style="background-color:#008080;">
                    <span style="font:14px;color:white;"><b><a style="color:white;text-decoration:none;" href="/PIS/WIP_PM_Dashboard/plantation_group?pg=PG2">PG 2</a></b></span>
                  </div>
                  <div class="card-body" style="padding:0;">
          ...
          gridLines: {
            ...
            <div class="col-md-4">
              <div class="row">
                <div class="card shadow" style="width:100%;">
                  <div class="card-header py-2 text-center" style="background-color:#008080;">
                    <span style="font:14px;color:white;"><b><a style="color:white;text-decoration:none;" href="/PIS/WIP_PM_Dashboard/plantation_group?pg=PG3">PG 3</a></b></span>
                  </div>
                  <div class="card-body" style="padding:0;">
...
function select_main_filter(){
  ...
  var bulan = $('#bulan').val();
  var umur = $('#umur').val();
  window.location.href="/PIS/WIP_PM_Dashboard?status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur;
}
