              ...
              <div class="col-lg-12 p-1">
                <div class="card shadow" style="width:100%;">
                  <div class="card-header py-0 text-center" style="background-color:#008080;">
                    <span style="color:white;font-size:14px;"><b>Quantity Insect I & II</b></span>
                  </div>
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm" style="font-weight:bold;">
                      <tr style="background-color:#008080;">
                        <td class="text-center" style="color:white;">Category</td>
                        <td class="text-center" style="color:white;">Kg/Ha</td>
                        <td class="text-center" style="color:white;">Total</td>
                      </tr>
                      <tr>
                        <td class="text-center">Insect I</td>
                        <td class="text-right"><?php echo angka_ribuan_2($unsur_real['Insect_1'] / $lokasi['luas']); ?></td>
                        <td class="text-right"><?php echo angka_ribuan_2($unsur_real['Insect_1']); ?></td>
                      </tr>
                      <tr>
                        <td class="text-center">Insect II</td>
                        <td class="text-right"><?php echo angka_ribuan_2($unsur_real['Insect_2'] / $lokasi['luas']); ?></td>
                        <td class="text-right"><?php echo angka_ribuan_2($unsur_real['Insect_2']); ?></td>
                      </tr>
                      <tr style="background-color:#008080;">
                        <td class="text-center" style="color:white;">Jumlah</td>
                        <td class="text-right" style="color:white;"><?php echo angka_ribuan_2(($unsur_real['Insect_1'] + $unsur_real['Insect_2']) / $lokasi['luas']); ?></td>
                        <td class="text-right" style="color:white;"><?php echo angka_ribuan_2(($unsur_real['Insect_1'] + $unsur_real['Insect_2'])); ?></td>
                      </tr>
                    </table>
                  </div>
                </div>
...
<script>
  function pindah_material(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code="+code_material+"&page=<?php echo $page; ?>&subpage=SPIN";
  }
