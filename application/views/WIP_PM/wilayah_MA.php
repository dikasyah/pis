                  ...
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm">
                      <tr style="background-color:#008080;font-weight:bold;">
                        ...
                        <td>
                          <select class="form-control select" name="select_unsur" id="select_unsur" onchange="javascript:select_main_filter();" data-live-search="true">
<?php
  $option_unsur_1 = "";
  $option_unsur_2 = "";
  $option_unsur_3 = "";
...
<script>
  ...
  function select_main_filter(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&unsur="+unsur+"&material="+material+"&lokasi="+lokasi+"&sort="+sort;
  }
