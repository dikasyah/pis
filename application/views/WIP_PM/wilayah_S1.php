                ...
                <div class="col-lg-4 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Performance PM</b></span>
                    </div>
                    <div class="card-body" style="padding:0;padding-top:5px;">
                      <canvas id="diagram_category_ha" style="padding:5px;"></canvas>
<?php
  $total_performance = $performance['Excellent'] + $performance['Good'] + $performance['Poor'];
  if($total_performance != NULL){
    $performance_ha = round(($performance['Excellent'] / $total_performance) * 100);
    $performance_ha .= ', '.round(($performance['Good'] / $total_performance) * 100);
    $performance_ha .= ', '.round(($performance['Poor'] / $total_performance) * 100);
  }
  else{
    $performance_ha = '0, 0, 0';
  }
?>
<script>
  var config_category_ha = {
    type: 'bar',
    data: {
          ...
          gridLines: {
            ...
            drawOnChartArea: false,
                ...
                <div class="col-lg-4 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Cost/Ha</b></span>
                    </div>
                    <div class="card-body" style="padding:0;padding-bottom:5px;">
                      <canvas id="diagram_cost_ha"></canvas>
<?php
  $a = 1;
  $cost_ha = "";
  $cost_std_ha = "";
  ...
  while ($a <= 21) {
    if($a == 1){
      $cost_ha_acc = $trend_cost['U'.$a];
      $cost_std_acc = $trend_cost['B'.$a];
      $cost_ha = round($cost_ha_acc / $luas);
      $cost_std_ha = round($cost_std_acc / $luas);
    }
    else{
      $cost_ha_acc += $trend_cost['U'.$a];
      $cost_std_acc += $trend_cost['B'.$a];
                        ...
                        <div class="col-lg-6">
                          <table class="table_pm" style="color:black;font-weight:bold;">
                            <tr class="text-center" style="background-color:#008080;">
                              <td colspan="2" style="color:white;">Expensive</td>
                            </tr>
                            <tr class="text-center" style="background-color:#008080;">
...
<?php
  foreach ($cost_real['Expensive'] as $cr) {
?>
                            <tr class="text-center">
                              <td style="color:black;"><a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=<?php echo $cr->lokasi; ?>'><?php echo $cr->lokasi; ?></a></td>
                              <td style="color:black;"><?php echo round($cr->cost); ?></td>
                            </tr>
<?php
  }
?>
                        ...
                        <div class="col-lg-6">
                          <table class="table_pm" style="color:black;font-weight:bold;">
                            <tr class="text-center" style="background-color:#008080;">
                              <td colspan="2" style="color:white;">Chippest</td>
                            </tr>
                            <tr class="text-center" style="background-color:#008080;">
                              <td style="color:white;">Lokasi</td>
                              <td style="color:white;">Cost</td>
...
<?php
  foreach ($cost_real['Chippest'] as $cr) {
?>
                            <tr class="text-center">
                              <td style="color:black;"><a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=<?php echo $cr->lokasi; ?>'><?php echo $cr->lokasi; ?></a></td>
                              <td style="color:black;"><?php echo round($cr->cost); ?></td>
...
<script>
  ...
  window.onload = function(){
		var ctx_category_ha = document.getElementById('diagram_category_ha').getContext('2d');
		window.myBar = new Chart(ctx_category_ha, config_category_ha);
		var ctx_cost_ha = document.getElementById('diagram_cost_ha').getContext('2d');
		window.myBar = new Chart(ctx_cost_ha, config_cost_ha);
  }
</script>
