  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=HM&wilayah=<?php echo $wilayah; ?>">
      ...
      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=ST&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Tanam</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=S1&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Cost</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=S2&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Production</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=S3&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Boom Spray</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=S4&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
      ...
      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=FE&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Fertilizer</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=HE&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Herbicide</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=IN&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Insecticide</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=FU&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Fungicide</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=FO&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Forcing</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=SP&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Springkle</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=HA&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
      ...
      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=MA&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
          <span class="text-white-600 small">Material</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=AC&wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
      ...
      <li class="nav-item">
        <a class="nav-link p-1" href="/PIS/index.php/WIP_PM_Dashboard/perlocation_wilayah?wilayah=<?php echo $wilayah; ?>">
          <i class="fas fa-fw fa-globe"></i>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <span class="d-none d-sm-inline-block" style="color:black;font-size:14px;"><b>
                <a href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?pg=<?php echo $wilayah_desc['plantation_group']; ?>"><?php echo $wilayah_desc['plantation_group']; ?></a> -
                <?php echo $wilayah_desc['code']; ?> -
                Bongkar
              </b></span>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?pg=<?php echo $wilayah_desc['plantation_group']; ?>" role="button" aria-expanded="false">
        ...
        <div class="container-fluid">
          ...
          <div class="row mb-2">
            <div class="col-lg-2 p-1">
              <div class="card shadow" style="width:100%;">
                ...
                <div class="card-body" style="padding:0;height:100px;background-color:#20B2AA;">
                  <br>
                  <input type="text" name="wilayah" id="wilayah" class="form-control" placeholder="Lokasi" style="background-color:#20B2AA;color:black;text-align:center;font-size:25px;height:50px;" maxlength="3" value="<?php echo $wilayah; ?>"/>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-10 p-1">
              <div class="card shadow" style="width:100%;">
                <div class="card-header py-0 text-center" style="background-color:#008080;font-size:14px;">
                  <span style="color:white;"><b>Profile <?php echo $wilayah; ?></b></span>
                </div>
                        ...
                        <table width="100%">
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <?php echo $wilayah_desc['kepala_wilayah']; ?>
                              </td>
                            </tr>
                            <tr>
                              <td>
                              ...
                              <td>
                                <?php echo $wilayah_desc['kasie_kebun1']; ?>
                              </td>
                            </tr>
                            <tr>
                              <td>
                              ...
                              <td>
                                <?php echo $wilayah_desc['kasie_kebun2']; ?>
                              </td>
                            </tr>
                            <tr>
                              <td>
                              ...
                              <td>
                                <?php echo $wilayah_desc['kasie_kebun3']; ?>
                              </td>
                            </tr>
                            <tr>
                              <td colspan="2">
...
?>
          ...
          <div class="row mb-1">
            <div class="col-lg-12 p-1">
              <select class="form-control select" name="select_lokasi" id="select_lokasi" onchange="javascript:pindah_lokasi();" data-live-search="true" style="color:black;font-weight:bold;">
                <option value="0" style="color:black;font-weight:bold;">Semua Lokasi</option>
<?php
  $cek = '';
...
?>
                <option value="<?php echo $l->lokasi_aktif; ?>" style="color:black;font-weight:bold;background-color:<?php echo $bgcolor_lokasi; ?>;"><?php echo $l->lokasi_aktif; ?>&emsp;&emsp;&emsp;<?php echo $cek; ?></option>
<?php
  }
?>
              </select>
              ...
              <div class="row mb-1">
                <div class="col-lg-12 p-1">
                  <table class="table_pm text-center" style="font-weight:bold;">
                    ...
                    <tr>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CChopper"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CMoldboard"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CDiskplow"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CHarrow"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CSubSoiling"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CFinishRotary"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CFinishHarrow"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CRidger"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CJalan"] / $luas); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($luas == 0 || $luas == NULL) echo "-"; else echo angka_ribuan($TimelineBK["CSaluran"] / $luas); ?></td>
                    </tr>
                  </table>
                </div>
              </div>
...
?>
                          <tr style="font-weight:bold;">
                            <td style="color:black;padding-top:2px;padding-bottom:2px;"><a style="color:blue;text-decoration:none;" href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=DEC&wilayah=<?php echo $wilayah_desc['code']; ?>&ga=<?php echo $ec->code; ?>&jenis_status=BK"><?php echo $ec->nama; ?></a></td>
                            <td class="text-right" style="color:black;padding-top:2px;padding-bottom:2px;"><?php echo angka_ribuan($CostBK[$ec->code."B"] / $CostBK["Luas"]); ?></td>
                            <td class="text-right" style="color:black;padding-top:2px;padding-bottom:2px;"><?php echo angka_ribuan($CostBK[$ec->code."R"] / $CostBK["Luas"]); ?></td>
                            <td class="text-right" style="color:black;padding-top:2px;padding-bottom:2px;"><?php echo angka_ribuan($HPP[$ec->code."H"] / $CostBK["Luas"]); ?></td>
                            <td class="text-right" style="color:black;padding-top:2px;padding-bottom:2px;"><?php echo angka_ribuan(($CostBK[$ec->code."R"] + $HPP[$ec->code."H"]) / $CostBK["Luas"]); ?></td>
                          </tr>
<?php
          $TotalCostBKB += $CostBK[$ec->code."B"];
          $TotalCostBKR += $CostBK[$ec->code."R"];
          $TotalCostBKH += $HPP[$ec->code."H"];
        break;
        default:
?>
                          <tr style="font-weight:bold;">
                            ...
                            <td class="text-right" style="color:black;padding-top:2px;padding-bottom:2px;"><?php echo angka_ribuan($CostBK[$ec->code."B"] / $CostBK["Luas"]); ?></td>
                            <td class="text-right" style="color:black;padding-top:2px;padding-bottom:2px;"><?php echo angka_ribuan($CostBK[$ec->code."R"] / $CostBK["Luas"]); ?></td>
                            <td class="text-right" style="color:black;padding-top:2px;padding-bottom:2px;"><?php echo angka_ribuan(0 / $CostBK["Luas"]); ?></td>
                            <td class="text-right" style="color:black;padding-top:2px;padding-bottom:2px;"><?php echo angka_ribuan($CostBK[$ec->code."R"] / $CostBK["Luas"]); ?></td>
                          </tr>
<?php
          $TotalCostBKB += $CostBK[$ec->code."B"];
  ...
  ?>
                        <tr style="background-color:#008080;font-weight:bold;">
                          ...
                          <td class="text-right" style="color:white;padding-top:10px;padding-bottom:10px;"><?php echo angka_ribuan($TotalCostBKB / $CostBK["Luas"]); ?></td>
                          <td class="text-right" style="color:white;padding-top:10px;padding-bottom:10px;"><?php echo angka_ribuan($TotalCostBKR / $CostBK["Luas"]); ?></td>
                          <td class="text-right" style="color:white;padding-top:10px;padding-bottom:10px;"><?php echo angka_ribuan($TotalCostBKH / $CostBK["Luas"]); ?></td>
                          <td class="text-right" style="color:white;padding-top:10px;padding-bottom:10px;"><?php echo angka_ribuan(($TotalCostBKR + $TotalCostBKH) / $CostBK["Luas"]); ?></td>
                        </tr>
                      </table>
                    </div>
                  </div>
                      ...
                      <div class="card shadow" style="width:100%;">
                        <div class="card-body" style="padding:0;overflow-x:auto;">
                          <table class="table_pm text-center" style="font-weight:bold;">
                            ...
                            <tr>
                              <td style="padding-top:5px;padding-bottom:5px;"><?php echo angka_ribuan($CostBK['Labour'] / $CostBK["Luas"]); ?></td>
                              <td style="padding-top:5px;padding-bottom:5px;"><?php echo angka_ribuan($CostBK['Material'] / $CostBK["Luas"]); ?></td>
                              <td style="padding-top:5px;padding-bottom:5px;"><?php echo angka_ribuan($CostBK['Charge'] / $CostBK["Luas"]); ?></td>
                              <td style="padding-top:5px;padding-bottom:5px;"><?php echo angka_ribuan($CostBK['Seed'] / $CostBK["Luas"]); ?></td>
                            </tr>
                            <tr style="background-color:#008080;">
                            ...
                            <tr>
                              <td style="padding-top:5px;padding-bottom:5px;" colspan="4"><?php echo angka_ribuan($TotalCostBKR / $CostBK["Luas"]); ?></td>
                            </tr>
                          </table>
                        </div>
                      </div>
...
<?php
  if($TotalCostBKB != 0){
    if(((($TotalCostBKR - $TotalCostBKB) / $TotalCostBKB) * 100) < -6.5){
      $CategoryBK = "Excellent";
      $CategoryBKColor = "#32CD32";
    }
    else if(((($TotalCostBKR - $TotalCostBKB) / $TotalCostBKB) * 100) <= 6.5){
      $CategoryBK = "Good";
...
?>
                              ...
                              <td style="padding-top:10px;padding-bottom:10px;color:black;"><?php if($TotalCostBKB != 0) echo round(((($TotalCostBKR - $TotalCostBKB) / $TotalCostBKB) * 100))." %"; else echo "-"; ?></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
...
<?php
  if($TotalCostBKR != NULL){
    $PGCLabour = round(($CostBK['Labour'] / $TotalCostBKR) * 100);
    $PGCCharge = round(($CostBK['Charge'] / $TotalCostBKR) * 100);
    $PGCMaterial = round(($CostBK['Material'] / $TotalCostBKR) * 100);
    $PGCSeed = round(($CostBK['Seed'] / $TotalCostBKR) * 100);
  }
  else{
      ...
      animation: {
        ...
        animateRotate: true
                ...
                <div class="col-lg-6 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Proportion Ex. Bongkar</b></span>
                    </div>
                    <div class="card-body" style="padding:0;overflow-x:auto;">
                      <canvas id="DiagramProporsiLuasBK" style="padding-top:5px;"></canvas>
<?php
  if($ProportionLuasBK['Total'] != NULL || $ProportionLuasBK != 0){
    $DatasetProportionLuasBK = round($ProportionLuasBK['NSBK'] / $ProportionLuasBK['Total'] * 100, 2);
    $DatasetProportionLuasBK .= ", ".round($ProportionLuasBK['PSBK'] / $ProportionLuasBK['Total'] * 100, 2);
    $DatasetProportionLuasBK .= ", ".round($ProportionLuasBK['SKBK'] / $ProportionLuasBK['Total'] * 100, 2);
    $DatasetProportionLuasBK .= ", ".round($ProportionLuasBK['NRBK'] / $ProportionLuasBK['Total'] * 100, 2);
    $DatasetProportionLuasBK .= ", ".round($ProportionLuasBK['NTBK'] / $ProportionLuasBK['Total'] * 100, 2);
    $DatasetProportionLuasBK .= ", ".round($ProportionLuasBK['NFBK'] / $ProportionLuasBK['Total'] * 100, 2);
    $DatasetProportionLuasBK .= ", ".round($ProportionLuasBK['JGBK'] / $ProportionLuasBK['Total'] * 100, 2);
  }
  else{
    $DatasetProportionLuasBK = ", , , , ";
  }
?>
<script>
  var ConfigProporsiLuasBK = {
    type: 'bar',
    data: {
      labels: ['NSBK', 'PSBK', 'SKBK', 'NRBK', 'NTBK', 'NFBK', 'JGBK'],
      datasets: [{
        type: 'bar',
        label: 'Proporsi',
        backgroundColor: [
        ...
        data: [
          <?php echo $DatasetProportionLuasBK; ?>
        ]
      }]
    },
    options: {
                ...
                <div class="col-lg-12 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-body" style="padding:0;overflow-x:auto;">
                      <table class="table_pm">
                        <tr style="background-color:#008080;font-weight:bold;">
                          <td style="color:white;">Land Preparation Quality : </td>
                          <td>
                            <select class="form-control select" name="select_qbk" id="select_qbk" onchange="javascript:select_main_filter();" data-live-search="true">
<?php
  $option_QualityBK1 = "";
  $option_QualityBK2 = "";
  switch ($QualityBK) {
    case 'Average':
      $option_QualityBK1 = "selected";
    break;
    case 'Scatter':
      $option_QualityBK2 = "selected";
    break;
  }
?>
                              <option value="Average" style="color:black;" <?php echo $option_QualityBK1; ?>>Average</option>
                              <option value="Scatter" style="color:black;" <?php echo $option_QualityBK2; ?>>Scatter</option>
                            </select>
                          </td>
                        </tr>
                      </table>
                ...
                <div class="col-lg-12 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-body" style="padding-top:5px;overflow-x:auto;">
                      <canvas id="DiagramQualityBK"></canvas>
<?php
  if($QualityBK == "Average"){
    if($QualityPBK["Chopper"]["T"] != NULL || $QualityPBK["Chopper"]["T"] != 0){
      $DataAverage = round($QualityPBK["Chopper"]["Q"] / $QualityPBK["Chopper"]["T"]);
    }
    else{
      $DataAverage = "";
    }
    if($QualityPBK["Bajak"]["T"] != NULL || $QualityPBK["Bajak"]["T"] != 0){
      $DataAverage .= ', '.round($QualityPBK["Bajak"]["Q"] / $QualityPBK["Bajak"]["T"]);
    }
    else{
      $DataAverage .= ", ";
    }
    if($QualityPBK["FinishingHarrow"]["T"] != NULL || $QualityPBK["FinishingHarrow"]["T"] != 0){
      $DataAverage .= ', '.round($QualityPBK["FinishingHarrow"]["Q"] / $QualityPBK["FinishingHarrow"]["T"]);
    }
    else{
      $DataAverage .= ", ";
    }
    if($QualityPBK["Ridger"]["T"] != NULL || $QualityPBK["Ridger"]["T"] != 0){
      $DataAverage .= ', '.round($QualityPBK["Ridger"]["Q"] / $QualityPBK["Ridger"]["T"]);
    }
    else{
      $DataAverage .= ", ";
    }
    if($QualityPBK["JalanSaluran"]["T"] != NULL || $QualityPBK["JalanSaluran"]["T"] != 0){
      $DataAverage .= ', '.round($QualityPBK["JalanSaluran"]["Q"] / $QualityPBK["JalanSaluran"]["T"]);
    }
    else{
      $DataAverage .= ", ";
    }
      ...
      $dataset .= "
        {
          ...
          showLine: false,
          data: [
            $QPBK->Chopper, $QPBK->Bajak, $QPBK->FinishingHarrow, $QPBK->Ridger, $QPBK->JalanSaluran
          ]
        },
      ";
    }
  }
  $STDPengamatan = round($STDQBKST['Chopper']).", ".round($STDQBKST['Bajak']).", ".round($STDQBKST['FinishingHarrow']).", ".round($STDQBKST['Ridger']).", ".round($STDQBKST['JalanSaluran']);
?>
<script>
  var ConfigQualityBK = {
    type: 'bar',
        ...
        xAxes: [{
          gridLines: {
            ...
            drawOnChartArea: false,
              ...
              <div class="row mb-1">
                <div class="col-lg-12 p-1">
                  <table class="table_pm text-center" style="font-weight:bold;">
                    ...
                    <tr>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($TQualityPBK["Total"] == 0) echo "-"; else echo angka_ribuan_2(($TQualityPBK["TChopper"] / $TQualityPBK["Total"]) * 100); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($TQualityPBK["Total"] == 0) echo "-"; else echo angka_ribuan_2(($TQualityPBK["TBajak"] / $TQualityPBK["Total"]) * 100); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($TQualityPBK["Total"] == 0) echo "-"; else echo angka_ribuan_2(($TQualityPBK["TFinishingHarrow"] / $TQualityPBK["Total"]) * 100); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($TQualityPBK["Total"] == 0) echo "-"; else echo angka_ribuan_2(($TQualityPBK["TRidger"] / $TQualityPBK["Total"]) * 100); ?></td>
                      <td style="padding-top:5px;padding-bottom:5px;"><?php if($TQualityPBK["Total"] == 0) echo "-"; else echo angka_ribuan_2(($TQualityPBK["TJalanSaluran"] / $TQualityPBK["Total"]) * 100); ?></td>
                    </tr>
                  </table>
                </div>
              </div>
              <div class="row mb-1">
                <div class="col-lg-6 p-1">
                  <button type="button" name="button" class="form-control btn btn-primary" onclick="DescriptionCharge('<?php echo $wilayah_desc['code']; ?>')">Description Charge</button>
                </div>
                <div class="col-lg-6 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-body" style="padding:0;">
                      <select style="color:black;" class="form-control select" name="select_activity_bk" id="select_activity_bk" onchange="javascript:select_main_filter();">
<?php
  $OptionActivityBK1 = "";
  $OptionActivityBK2 = "";
  $OptionActivityBK3 = "";
  ...
  switch($ActivityBK){
    case 'Chopper_1':
      $OptionActivityBK1 = "selected";
    break;
    case 'Chopper_2':
      $OptionActivityBK2 = "selected";
    break;
    case 'Moldboard_1':
      $OptionActivityBK3 = "selected";
    break;
    case 'Diskplow_1':
      $OptionActivityBK4 = "selected";
    break;
    case 'Diskplow_2':
      $OptionActivityBK5 = "selected";
    break;
    case 'Diskplow_3':
      $OptionActivityBK6 = "selected";
    break;
    case 'Harrow_1':
      $OptionActivityBK7 = "selected";
    break;
    case 'Harrow_2':
      $OptionActivityBK8 = "selected";
    break;
    case 'Sub|Soiling_1':
      $OptionActivityBK9 = "selected";
    break;
    case 'Finish|Rotary_1':
      $OptionActivityBK10 = "selected";
    break;
    case 'Finish|Harrow_1':
      $OptionActivityBK11 = "selected";
    break;
    case 'Ridger_1':
      $OptionActivityBK12 = "selected";
    break;
    case 'Jalan_1':
      $OptionActivityBK13 = "selected";
    break;
    case 'Saluran_1':
      $OptionActivityBK14 = "selected";
    break;
  }
?>
                        <option value="Chopper_1" style="color:black;" <?php echo $OptionActivityBK1; ?>>Chopper 1</option>
                        <option value="Chopper_2" style="color:black;" <?php echo $OptionActivityBK2; ?>>Chopper 2</option>
                        <option value="Moldboard_1" style="color:black;" <?php echo $OptionActivityBK3; ?>>Moldboard</option>
                        <option value="Diskplow_1" style="color:black;" <?php echo $OptionActivityBK4; ?>>Diskplow 1</option>
                        <option value="Diskplow_2" style="color:black;" <?php echo $OptionActivityBK5; ?>>Diskplow 2</option>
                        <option value="Diskplow_3" style="color:black;" <?php echo $OptionActivityBK6; ?>>Diskplow 3</option>
                        <option value="Harrow_1" style="color:black;" <?php echo $OptionActivityBK7; ?>>Harrow 1</option>
                        <option value="Harrow_2" style="color:black;" <?php echo $OptionActivityBK8; ?>>Harrow 2</option>
                        <option value="Sub|Soiling_1" style="color:black;" <?php echo $OptionActivityBK9; ?>>Sub Soiling</option>
                        <option value="Finish|Rotary_1" style="color:black;" <?php echo $OptionActivityBK10; ?>>Finish Rotary</option>
                        <option value="Finish|Harrow_1" style="color:black;" <?php echo $OptionActivityBK11; ?>>Finish Harrow</option>
                        <option value="Ridger_1" style="color:black;" <?php echo $OptionActivityBK12; ?>>Ridger</option>
                        <option value="Jalan_1" style="color:black;" <?php echo $OptionActivityBK13; ?>>Jalan</option>
                        <option value="Saluran_1" style="color:black;" <?php echo $OptionActivityBK14; ?>>Saluran</option>
                      </select>
                    </div>
                  </div>
                </div>
              ...
              <div class="row mb-1">
                <div class="col-lg-6 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Penarik</b></span>
                    </div>
                    <div class="card-body" style="padding:0;overflow-x:auto;">
                      <canvas id="DiagramPenarik"></canvas>
<?php
  if($ActivityPenarik["Total"] != NULL){
    $SummaryPenarik = round(($ActivityPenarik["T1"] / $ActivityPenarik["Total"]) * 100);
    $SummaryPenarik .= ", ".round(($ActivityPenarik["T2"] / $ActivityPenarik["Total"]) * 100);
    $SummaryPenarik .= ", ".round(($ActivityPenarik["T3"] / $ActivityPenarik["Total"]) * 100);
    $SummaryPenarik .= ", ".round(($ActivityPenarik["T4"] / $ActivityPenarik["Total"]) * 100);
    $SummaryPenarik .= ", ".round(($ActivityPenarik["T5"] / $ActivityPenarik["Total"]) * 100);
  }
  else{
    $SummaryPenarik = "0, 0, 0, 0, 0";
  }
?>
<script>
  var ConfigPenarik = {
      ...
      animation: {
        ...
        animateRotate: true
                ...
                <div class="col-lg-6 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-header py-0 text-center" style="background-color:#008080;">
                      <span style="color:white;font-size:14px;"><b>Implement</b></span>
                    </div>
                    <div class="card-body" style="padding:0;overflow-x:auto;">
                      <canvas id="DiagramImplement"></canvas>
<?php
  if($ActivityImplement["Total"] != NULL){
    switch ($CurrentActivityBK) {
      case 'Chopper':
        $SummaryName = "'Berti', 'Fae', 'Fecon', 'GGP', 'Jumbo', 'Kulin', 'LU'";
        $SummaryColor = "'#4169E1', '#FF8C00', '#228B22', '#FF0000', '#0000FF', '#00FFFF', '#00FF00'";
        $SummaryPenarik = round(($ActivityImplement["T1"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T2"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T3"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T4"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T5"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T6"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T7"] / $ActivityImplement["Total"]) * 100);
      break;
      case 'Moldboard':
        $SummaryName = "'Kulin', '2,5 BTR', '5 BTR', 'Revers. Kulin', 'Single Kulin', 'GGP', 'Howard'";
        $SummaryColor = "'#4169E1', '#FF8C00', '#228B22', '#FF0000', '#0000FF', '#00FFFF', '#00FF00'";
        $SummaryPenarik = round(($ActivityImplement["T1"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T2"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T3"] / $ActivityImplement["Total"]) * 100);
      ...
      break;
      case 'Diskplow':
        $SummaryName = "'PGN0D01', 'KDK0D01', 'Rental'";
        $SummaryColor = "'#4169E1', '#FF8C00', '#228B22'";
        $SummaryPenarik = round(($ActivityImplement["T1"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T2"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T3"] / $ActivityImplement["Total"]) * 100);
      break;
      case 'Harrow':
        $SummaryName = "'CH64', 'FHK', 'TRCW', 'TRH', 'Rental'";
        $SummaryColor = "'#4169E1', '#FF8C00', '#228B22', '#FF0000', '#0000FF'";
        $SummaryPenarik = round(($ActivityImplement["T1"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T2"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T3"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T4"] / $ActivityImplement["Total"]) * 100);
      ...
      break;
      case 'Sub Soiling':
        $SummaryName = "'Mounted', 'R&R'";
        $SummaryColor = "'#4169E1', '#FF8C00'";
        $SummaryPenarik = round(($ActivityImplement["T1"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T2"] / $ActivityImplement["Total"]) * 100);
      break;
      case 'Finish Rotary':
        $SummaryName = "'Berti', 'Fae', 'Fecon', 'Jumbo', 'Kulin', 'LU', 'Tiller Nortwest', 'Rental'";
        $SummaryColor = "'#4169E1', '#FF8C00', '#228B22', '#FF0000', '#0000FF', '#00FFFF', '#00FF00', '#FF00FF'";
        $SummaryPenarik = round(($ActivityImplement["T1"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T2"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T3"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T4"] / $ActivityImplement["Total"]) * 100);
        ...
        $SummaryPenarik .= ", ".round(($ActivityImplement["T6"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T7"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T8"] / $ActivityImplement["Total"]) * 100);
      break;
      case 'Finish Harrow':
        $SummaryName = "'CH64', 'FHK', 'TRCW', 'TRH', 'Rental'";
        $SummaryColor = "'#4169E1', '#FF8C00', '#228B22', '#FF0000', '#0000FF', '#00FFFF', '#00FF00'";
      ...
      break;
      case 'Ridger':
        $SummaryName = "'Palir', 'Saluran', 'Single Row', 'Double Row', 'Standard', 'GGP', 'Rental'";
        $SummaryColor = "'#4169E1', '#FF8C00', '#228B22', '#FF0000', '#0000FF', '#00FFFF', '#00FF00'";
        $SummaryPenarik = round(($ActivityImplement["T1"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T2"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T3"] / $ActivityImplement["Total"]) * 100);
      ...
      break;
      case 'Saluran':
        $SummaryName = "'Ridger Standard', 'Ridger Saluran', 'Ridger GGP'";
        $SummaryColor = "'#4169E1', '#FF8C00', '#228B22', '#FF0000', '#0000FF', '#00FFFF', '#00FF00'";
        $SummaryPenarik = round(($ActivityImplement["T1"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T2"] / $ActivityImplement["Total"]) * 100);
        $SummaryPenarik .= ", ".round(($ActivityImplement["T3"] / $ActivityImplement["Total"]) * 100);
  ...
  var ConfigImplement = {
    ...
    data: {
      datasets: [{
        ...
        backgroundColor: [
          <?php echo $SummaryColor; ?>
        ],
        label: 'Cost and Production'
      }],
      labels: [
        <?php echo $SummaryName; ?>
      ]
      },
      options: {
      responsive: true,
                  ...
                  <div class="card shadow" style="width:100%;">
                    ...
                    <div class="card-body" style="padding:0;overflow-x:auto;">
                      <table class="table_pm text-center" style="font-weight:bold;">
                        ...
                        <tr>
<?php
  if(($RealActivity['Total'] / $RealActivity['Aplikasi']) > ($STDActivity['Biaya'] / $luas)){
    $ColorRealActBK = "#FF0000";
  }
  else{
    $ColorRealActBK = "#32CD32";
  }
?>
                          <td style="padding-top:5px;padding-bottom:5px;background-color:<?php echo $ColorRealActBK; ?>;"><?php echo angka_ribuan($RealActivity['Total'] / $RealActivity['Aplikasi']); ?></td>
                          <td style="padding-top:5px;padding-bottom:5px;"><?php echo angka_ribuan($STDActivity['Biaya'] / $luas); ?></td>
                        </tr>
                      </table>
                    </div>
                  </div>
...
<script>
  ...
  function select_main_filter(){
    ...
    var activity_bk = $('#select_activity_bk').val();
    var qbk = $('#select_qbk').val();

    var wilayah = $('#wilayah').val();
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&status_bk="+status_bk+"&activity_bk="+activity_bk+"&qbk="+qbk;
  }
  function pindah_lokasi(){
    window.location.href="/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi="+$('#select_lokasi').val();
  }
  window.onload = function(){
		var CtxQualityBK = document.getElementById('DiagramQualityBK').getContext('2d');
		window.myBar = new Chart(CtxQualityBK, ConfigQualityBK);
		var CtxProporsiLuasBK = document.getElementById('DiagramProporsiLuasBK').getContext('2d');
		window.myBar = new Chart(CtxProporsiLuasBK, ConfigProporsiLuasBK);
		var CtxGCReal = document.getElementById('DiagramGCReal').getContext('2d');
		window.myBar = new Chart(CtxGCReal, ConfigGCReal);
		var CtxPenarik = document.getElementById('DiagramPenarik').getContext('2d');
		window.myBar = new Chart(CtxPenarik, ConfigPenarik);
		var CtxImplement = document.getElementById('DiagramImplement').getContext('2d');
		window.myBar = new Chart(CtxImplement, ConfigImplement);
  }
  function DescriptionCharge(wilayah){
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?wilayah="+wilayah+"&page=DBK";
  }
</script>
