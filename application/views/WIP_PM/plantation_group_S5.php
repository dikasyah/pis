      ...
      animation: {
        ...
        animateRotate: true
            ...
            <div class="col-lg-4 p-1">
              <div class="card shadow" style="width:100%;">
                <div class="card-header py-0 text-center" style="background-color:#008080;font-size:14px;">
                  <span style="color:white;"><b>Lokasi Foliar After Forcing</b></span>
                </div>
                <div class="card-body" style="padding:0;">
                  <table class="table_pm">
                    <tr style="background-color:#008080;">
                      <td style="font-weight:bold;color:white;">Lokasi</td>
                      <td style="font-weight:bold;color:white;">Kali</td>
                      <td style="font-weight:bold;color:white;">Lokasi</td>
                      <td style="font-weight:bold;color:white;">Kali</td>
                      <td style="font-weight:bold;color:white;">Lokasi</td>
                      <td style="font-weight:bold;color:white;">Kali</td>
                    ...
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[1])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[1]['lokasi']."'>".$lokasi_foliar[1]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[1])) echo $lokasi_foliar[1]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[11])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[11]['lokasi']."'>".$lokasi_foliar[11]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[11])) echo $lokasi_foliar[11]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[21])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[21]['lokasi']."'>".$lokasi_foliar[21]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[21])) echo $lokasi_foliar[21]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[2])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[2]['lokasi']."'>".$lokasi_foliar[2]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[2])) echo $lokasi_foliar[2]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[12])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[12]['lokasi']."'>".$lokasi_foliar[12]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[12])) echo $lokasi_foliar[12]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[22])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[22]['lokasi']."'>".$lokasi_foliar[22]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[22])) echo $lokasi_foliar[22]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[3])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[3]['lokasi']."'>".$lokasi_foliar[3]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[3])) echo $lokasi_foliar[3]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[13])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[13]['lokasi']."'>".$lokasi_foliar[13]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[13])) echo $lokasi_foliar[13]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[23])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[23]['lokasi']."'>".$lokasi_foliar[23]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[23])) echo $lokasi_foliar[23]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[4])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[4]['lokasi']."'>".$lokasi_foliar[4]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[4])) echo $lokasi_foliar[4]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[14])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[14]['lokasi']."'>".$lokasi_foliar[14]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[14])) echo $lokasi_foliar[14]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[24])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[24]['lokasi']."'>".$lokasi_foliar[24]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[24])) echo $lokasi_foliar[24]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[5])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[5]['lokasi']."'>".$lokasi_foliar[5]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[5])) echo $lokasi_foliar[5]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[15])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[15]['lokasi']."'>".$lokasi_foliar[15]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[15])) echo $lokasi_foliar[15]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[25])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[25]['lokasi']."'>".$lokasi_foliar[25]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[25])) echo $lokasi_foliar[25]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[6])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[6]['lokasi']."'>".$lokasi_foliar[6]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[6])) echo $lokasi_foliar[6]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[16])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[16]['lokasi']."'>".$lokasi_foliar[16]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[16])) echo $lokasi_foliar[16]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[26])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[26]['lokasi']."'>".$lokasi_foliar[26]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[26])) echo $lokasi_foliar[26]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[7])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[7]['lokasi']."'>".$lokasi_foliar[7]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[7])) echo $lokasi_foliar[7]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[17])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[17]['lokasi']."'>".$lokasi_foliar[17]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[17])) echo $lokasi_foliar[17]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[27])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[27]['lokasi']."'>".$lokasi_foliar[27]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[27])) echo $lokasi_foliar[27]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[8])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[8]['lokasi']."'>".$lokasi_foliar[8]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[8])) echo $lokasi_foliar[8]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[18])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[18]['lokasi']."'>".$lokasi_foliar[18]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[18])) echo $lokasi_foliar[18]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[28])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[28]['lokasi']."'>".$lokasi_foliar[28]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[28])) echo $lokasi_foliar[28]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[9])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[9]['lokasi']."'>".$lokasi_foliar[9]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[9])) echo $lokasi_foliar[9]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[19])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[19]['lokasi']."'>".$lokasi_foliar[19]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[19])) echo $lokasi_foliar[19]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[29])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[29]['lokasi']."'>".$lokasi_foliar[29]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[29])) echo $lokasi_foliar[29]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                    <tr>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[10])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[10]['lokasi']."'>".$lokasi_foliar[10]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[10])) echo $lokasi_foliar[10]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[20])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[20]['lokasi']."'>".$lokasi_foliar[20]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[20])) echo $lokasi_foliar[20]['Foliar']." Kali"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[30])) echo "<a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=".$lokasi_foliar[30]['lokasi']."'>".$lokasi_foliar[30]['lokasi']."</a>"; else echo "-"; ?></td>
                      <td style="font-weight:bold;color:black;"><?php if(isset($lokasi_foliar[30])) echo $lokasi_foliar[30]['Foliar']." Kali"; else echo "-"; ?></td>
                    </tr>
                  </table>
                </div>
              </div>
...
<script>
  ...
  function select_main_filter(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?page=<?php echo $page; ?>&pg="+pg+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&type="+type+"&umur_f="+umur_f;
  }
