                  ...
                  <table class="table_pm">
                    <thead>
                      <tr class="text-center" style="background-color:#008080;font-weight:bold;">
                        <td style="color:white;" colspan="2" rowspan="2" style="color:white;">Activity</td>
...
<?php
  ...
  $ZNVariance = $ZN04_real['total'] - $total_real;
  if($ZNVariance <= 0){
    $color_std = "#32CD32";
    $color_real = "#32CD32";
  }
  ...
  $total_real += $ZNVariance;
?>
                      <tr>
                        <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                        <td>Varian Cost</td>
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan(0); ?></td>
                        <td class="text-right" style="font-weight:bold;color:<?php echo $color_real; ?>;"><?php echo angka_ribuan(($ZNVariance / $luas)); ?></td>
                      </tr>
<?php
                ...
                <div class="col-lg-9">
                  <div class="row mb-1">
                    <div class="col-lg-12 p-1">
                      <div class="card shadow" style="width:100%;">
                        <div class="card-header py-0 text-center" style="background-color:#008080;">
                          <span style="color:white;font-size:14px;"><b>Trend Road & Drainage</b></span>
                        </div>
