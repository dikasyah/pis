...
<?php
  $total_weed_man = $weed_man['W1'] + $weed_man['W2'] + $weed_man['W3'] + $weed_man['W4'];
  if($total_weed_man != 0){
    $width_s1 = round(($weed_man['W1'] / $total_weed_man) * 100) - 10;
    $width_s2 = round(($weed_man['W2'] / $total_weed_man) * 100);
    $width_s3 = round(($weed_man['W3'] / $total_weed_man) * 100) + 10;
    $width_s4 = round(($weed_man['W4'] / $total_weed_man) * 100) + 20;
  }
  else{
    $width_s1 = 0;
    $width_s2 = 0;
...
?>
                      <tr>
                        <td style="padding-top:75px;padding-bottom:75px;background-color:#008000;" width="<?php echo $width_s1; ?>%">W < 4<br /><?php if($weed_man['W1'] != 0) echo $weed_man['W1']; else echo "-"; ?> Lokasi</td>
                        <td style="padding-top:75px;padding-bottom:75px;background-color:#0000FF;" width="<?php echo $width_s2; ?>%">4 < W < 7<br /><?php if($weed_man['W2'] != 0) echo $weed_man['W2']; else echo "-"; ?> Lokasi</td>
                        <td style="padding-top:75px;padding-bottom:75px;background-color:#FFFF00;" width="<?php echo $width_s3; ?>%">7 < W < 10<br /><?php if($weed_man['W3'] != 0) echo $weed_man['W3']; else echo "-"; ?> Lokasi</td>
                        <td style="padding-top:75px;padding-bottom:75px;background-color:#FF0000;" width="<?php echo $width_s4; ?>%">W > 10<br /><?php if($weed_man['W4'] != 0) echo $weed_man['W4']; else echo "-"; ?> Lokasi</td>
                      </tr>
                    </table>
                  </div>
                </div>
...
?>
                            ...
                            <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Bromacyl'] / $luas); ?></td>
...
?>
                            ...
                            <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Diuron'] / $luas); ?></td>
...
?>
                            ...
                            <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Glyphosate'] / $luas); ?></td>
...
?>
                            ...
                            <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Quizalofop'] / $luas); ?></td>
...
?>
                            ...
                            <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Ametrine'] / $luas); ?></td>
...
?>
                            ...
                            <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Bazza'] / $luas); ?></td>
...
?>
                            ...
                            <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan_2($std_material_quota['Oksifluorfen'] / $luas); ?></td>
                      ...
                      <div class="card-body" style="padding:0;">
                        <table class="table_pm text-center" style="font-weight:bold;">
                          <tr style="background-color:#008080;">
                            <td style="font-weight:bold;color:white;" colspan='3'>Interval Herbicide <?php echo $booster; ?> Planting</td>
                          </tr>
                          <tr style="background-color:#008080;">
                            <td style="color:white;padding-top:12px;padding-bottom:12px;">Max</td>
                            <td style="color:white;padding-top:12px;padding-bottom:12px;" rowspan="2">Average<br/><?php echo round($pre_post['Avg']); ?> Hari</td>
                            <td style="color:white;padding-top:12px;padding-bottom:12px;">Min</td>
                          </tr>
                          <tr>
                            <td style="padding-top:12px;padding-bottom:12px;"><?php echo $pre_post['Max']; ?> Hari</td>
                            <td style="padding-top:12px;padding-bottom:12px;"><?php echo $pre_post['Min']; ?> Hari</td>
                          </tr>
                        </table>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-12 p-1">
                    <div class="card shadow" style="width:100%;">
                      <div class="card-body" style="padding:0;">
                        <table class="table_pm">
                          <tr style="background-color:#008080;">
                            <td style="font-weight:bold;color:white;">Interval Herbicide</td>
                            <td>
                              <select class="form-control select" name="select_booster" id="select_booster" onchange="javascript:select_main_filter();" style="font-weight:bold;color:black;">
  <?php
    $option_booster_1 = "";
    $option_booster_2 = "";
    switch ($booster) {
      case 'Pre':
        $option_booster_1 = "selected";
      break;
      case 'Post':
        $option_booster_2 = "selected";
      break;
    }
  ?>
                                <option value="Pre" style="color:black;font-weight:bold;" <?php echo $option_booster_1; ?>>Pre Planting</option>
                                <option value="Post" style="color:black;font-weight:bold;" <?php echo $option_booster_2; ?>>Post Planting</option>
                              </select>
                            </td>
                          </tr>
                        </table>
                ...
                <div class="row">
                  <div class="col-lg-12 p-1">
                    <div class="card shadow" style="width:100%;">
                      <div class="card-body" style="padding:0;">
                        <canvas id="diagram_interval_booster"></canvas>
<?php
  if($pre_post['R'] + $pre_post['N'] != NULL){
    $pre_post_r = round(($pre_post['R'] / ($pre_post['R'] + $pre_post['N'])) * 100);
    $pre_post_n = round(($pre_post['N'] / ($pre_post['R'] + $pre_post['N'])) * 100);
  }
  else{
    $pre_post_r = round((0) * 100);
    $pre_post_n = round((0) * 100);
  }
  $total_pre_post = $pre_post_r.', '.$pre_post_n;
  if($booster == 'Pre'){
    $name = '(4 - 10 Hari)';
  }
  else{
...
?>
  <script>
    var config_interval_booster = {
      type: 'doughnut',
      data: {
        datasets: [{
          data: [
            <?php echo $total_pre_post; ?>
          ],
          backgroundColor: [
            '#4169E1',
            '#FF8C00'
              ...
              <div class="col-lg-4 p-1">
                <div class="card shadow" style="width:100%;">
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm text-center" style="font-weight:bold;">
                      <tr style="background-color:#008080;">
                        <td style="color:white;padding-top:15px;padding-bottom:15px;" colspan="2">Rata-Rata Weeding Manual</td>
                      </tr>
                      <tr>
                        <td style="padding-top:20px;padding-bottom:20px;"><h2><?php echo ceil($avg_weed_man['Weed_Man']); ?></h2></td>
                        <td style="padding-top:20px;padding-bottom:20px;"><h2><?php echo angka_ribuan($avg_weed_man['Rp_Weed_Man']); ?></h2></td>
                      </tr>
                      <tr style="background-color:#008080;">
                        <td style="color:white;padding-top:10px;padding-bottom:10px;">Kali</td>
                        <td style="color:white;padding-top:10px;padding-bottom:10px;">Rp/Ha<br />Per Application</td>
                      </tr>
                    </table>
                  </div>
                </div>
...
?>
                          <tr class="text-center">
                            <td style="background-color:#008000;height:<?php echo $width_sebaran_1; ?>%;"><?php echo $sebaran['1']['activity_desc']; ?> (<?php echo angka_ribuan($width_sebaran_1); ?>%)</td>
                          </tr>
                          <tr class="text-center">
                            <td style="background-color:#9ACD32;height:<?php echo $width_sebaran_2; ?>%;"><?php echo $sebaran['2']['activity_desc']; ?> (<?php echo angka_ribuan($width_sebaran_2); ?>%)</td>
                          </tr>
                          <tr class="text-center">
                            <td style="background-color:#FF8C00;height:<?php echo $width_sebaran_3; ?>%;"><?php echo $sebaran['3']['activity_desc']; ?> (<?php echo angka_ribuan($width_sebaran_3); ?>%)</td>
                          </tr>
                          <tr class="text-center">
                            <td style="background-color:#B22222;height:<?php echo $width_sebaran_4; ?>%;"><?php echo $sebaran['4']['activity_desc']; ?> (<?php echo angka_ribuan($width_sebaran_4); ?>%)</td>
                          </tr>
                          <tr class="text-center">
                            <td style="background-color:#0022FF;height:<?php echo $width_sebaran_5; ?>%;"><?php echo $sebaran['5']['activity_desc']; ?> (<?php echo angka_ribuan($width_sebaran_5); ?>%)</td>
                          </tr>
<?php
  }
  else{
...
<script>
  ...
  function select_main_filter(){
    ...
    var booster = $('#select_booster').val();
    var sebaran = $('#select_sebaran').val();
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?page=<?php echo $page; ?>&pg="+pg+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&herbicide="+herbicide+"&type="+type+"&herbicide_2="+herbicide_2+"&compare="+compare+"&booster="+booster+"&sebaran="+sebaran;
  }
  ...
  window.onload = function(){
		...
		var ctx_interval_booster = document.getElementById('diagram_interval_booster').getContext('2d');
		window.myBar = new Chart(ctx_interval_booster, config_interval_booster);
	};
</script>
