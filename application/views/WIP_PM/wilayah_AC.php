                  ...
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm">
                      <tr style="background-color:#008080;font-weight:bold;">
                        <td style="color:white;">Group Activity : </td>
                        <td>
                          <select class="form-control select" name="select_group_activity" id="select_group_activity" onchange="javascript:select_main_filter(1);" data-live-search="true">
<?php
  $option_ga_1 = "";
  $option_ga_2 = "";
  $option_ga_3 = "";
  ...
  switch ($ga) {
    case 'ZN01':
      $option_ga_1 = "selected";
    break;
    case 'ZN02':
      $option_ga_2 = "selected";
    break;
    case 'ZN03':
      $option_ga_3 = "selected";
    break;
    case 'ZN04':
      $option_ga_4 = "selected";
    break;
    case 'ZN05':
      $option_ga_5 = "selected";
    break;
    case 'ZN06':
      $option_ga_6 = "selected";
    break;
    case 'ZN07':
      $option_ga_7 = "selected";
    break;
    case 'ZN08':
      $option_ga_8 = "selected";
    break;
    case 'ZN09':
      $option_ga_9 = "selected";
    break;
    case 'ZN10':
      $option_ga_10 = "selected";
    break;
    case 'ZN11':
      $option_ga_11 = "selected";
    break;
    case 'ZN12':
      $option_ga_12 = "selected";
    break;
    case 'ZN13':
      $option_ga_13 = "selected";
    break;
    case 'ZN14':
      $option_ga_14 = "selected";
    break;
    case 'ZN15':
      $option_ga_15 = "selected";
    break;
  }
?>
                            <option value="ZN01" style="color:black;" <?php echo $option_ga_1; ?>>Land Preparation</option>
                            <option value="ZN02" style="color:black;" <?php echo $option_ga_2; ?>>Seedling</option>
                            <option value="ZN03" style="color:black;" <?php echo $option_ga_3; ?>>Planting</option>
                            <option value="ZN04" style="color:black;" <?php echo $option_ga_4; ?>>Road & Drainage</option>
                            <option value="ZN05" style="color:black;" <?php echo $option_ga_5; ?>>Fertilization</option>
                            <option value="ZN06" style="color:black;" <?php echo $option_ga_6; ?>>Weed Control</option>
                            <option value="ZN07" style="color:black;" <?php echo $option_ga_7; ?>>Plant Pest Control</option>
                            <option value="ZN08" style="color:black;" <?php echo $option_ga_8; ?>>Forcing</option>
                            <option value="ZN09" style="color:black;" <?php echo $option_ga_9; ?>>Pre Harvesting</option>
                            <option value="ZN10" style="color:black;" <?php echo $option_ga_10; ?>>Harvesting</option>
                            <option value="ZN11" style="color:black;" <?php echo $option_ga_11; ?>>Observation</option>
                            <option value="ZN12" style="color:black;" <?php echo $option_ga_12; ?>>Plant Selection</option>
                            <option value="ZN13" style="color:black;" <?php echo $option_ga_13; ?>>Springkle / Irrigation</option>
                            <option value="ZN14" style="color:black;" <?php echo $option_ga_14; ?>>Guard / Pull / Labor or Transportation</option>
                            <option value="ZN15" style="color:black;" <?php echo $option_ga_15; ?>>Others</option>
                          </select>
                        </td>
                      </tr>
                    </table>
                  ...
                  <div class="card-body" style="padding:0;overflow-x:auto;">
                    <table class="table_pm">
                      <tr class="text-center" style="background-color:#008080;font-weight:bold;">
                        <td rowspan="2" colspan="2" style="color:white;">Activity</td>
                        <td colspan="2" style="color:white;">Biaya (Rp/Ha)</td>
                        <td rowspan="2" style="color:white;">Over Proportion</td>
                      </tr>
                      <tr class="text-center" style="background-color:#008080;font-weight:bold;">
...
<?php
  $total_real = 0;
  $total_budget = 0;
  foreach ($master_activity as $act) {
    if(isset($activity_real['A'.$act->code_activity])){
      $ar_actual = $activity_real['A'.$act->code_activity];
    }
    else{
      $ar_actual = 0;
    }
    if($activity_budget['A'.$act->code_activity] >= $ar_actual){
      $color_std = "#32CD32";
      $color_real = "#32CD32";
    }
    else{
    ...
    if($ar_actual > 0 && $ga == 'ZN03'){
      $total_real += $ar_actual;
      $total_budget += $activity_budget['A'.$act->code_activity] * 0.3;
    }
    else if($ga != 'ZN03'){
      $total_real += $ar_actual;
      $total_budget += $activity_budget['A'.$act->code_activity];
    }
  ?>
                      <tr>
                        <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                        <td><a style="color:black;text-decoration:none;" href="#"><?php echo $act->desc_activity; ?></a></td>
<?php
    if($ar_actual > 0 && $ga == 'ZN03'){
?>
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan(($activity_budget['A'.$act->code_activity] * 0.3) / $luas); ?></td>
<?php
    }
    else if($ga == 'ZN03'){
?>
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan(0 / $luas); ?></td>
<?php
    }
    else{
?>
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan($activity_budget['A'.$act->code_activity] / $luas); ?></td>
<?php
    }
?>
                        <td class="text-right" style="font-weight:bold;color:<?php echo $color_real; ?>;"><?php echo angka_ribuan($ar_actual / $luas); ?></td>
                        <td class="text-right" style="font-weight:bold;"><?php if(isset($activity_over['A'.$act->code_activity])) echo angka_ribuan(($activity_over['A'.$act->code_activity]) * 100); else echo angka_ribuan(0); ?> %</td>
                      </tr>
<?php
  }
  if($tahun == date('Y', strtotime($YEAR_BASE['nilai'])) || ($ga == 'ZN04' || $ga == 'ZN03' || $ga == 'ZN01')){
    $ZN04 = $wip[$ga.'_r'] - $total_real;
    if($ZN04 <= 0){
      $color_std = "#32CD32";
      $color_real = "#32CD32";
    }
...
?>
                      <tr>
                        <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                        <td>Varian Cost</td>
                        <td class="text-right" style="font-weight:bold;"><?php echo angka_ribuan(0); ?></td>
                        <td class="text-right" style="font-weight:bold;color:<?php echo $color_real; ?>;"><?php echo angka_ribuan(($ZN04 / $luas)); ?></td>
                        <td class="text-right" style="font-weight:bold;">- %</td>
                      </tr>
<?php
  }
  if($total_budget >= $total_real){
    $color_real = "#32CD32";
  }
  else{
    $color_real = "#FF0000";
...
?>
                      <tr style="font-weight:bold;">
                        ...
                        <td class="text-right"><?php echo angka_ribuan($total_budget / $luas); ?></td>
          ...
          <div class="col-lg-2 p-1">
            <div class="card shadow" style="width:100%;">
              <div class="card-body" style="padding:0;height:580px;">
                <table class="table_pm" style="font-weight:bold;height:100%;">
                  <tr class="text-center">
                    <td style="background-color:#008000;height:<?php if($group_cost['Total'] != 0) echo round($group_cost['Charge'] / $group_cost['Total'] * 100); else echo 0; ?>%;">Charge (<?php if($group_cost['Total'] != 0) echo round($group_cost['Charge'] / $group_cost['Total'] * 100); else echo "-"; ?>%)</td>
                  </tr>
                  <tr class="text-center">
                    <td style="background-color:#0000FF;height:<?php if($group_cost['Total'] != 0) echo round($group_cost['Material'] / $group_cost['Total'] * 100); else echo 0; ?>%;">Material (<?php if($group_cost['Total'] != 0) echo round($group_cost['Material'] / $group_cost['Total'] * 100); else echo "-"; ?>%)</td>
                  </tr>
                  <tr class="text-center">
                    <td style="background-color:#FF8C00;height:<?php if($group_cost['Total'] != 0) echo round($group_cost['Labour'] / $group_cost['Total'] * 100); else echo 0; ?>%;">Labour (<?php if($group_cost['Total'] != 0) echo round($group_cost['Labour'] / $group_cost['Total'] * 100); else echo "-"; ?>%)</td>
                  </tr>
                </table>
              </div>
            </div>
                  ...
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm">
                      <tr style="background-color:#008080;font-weight:bold;">
                        ...
                        <td>
                          <select class="form-control select" name="select_activity" id="select_activity" onchange="javascript:select_main_filter();" data-live-search="true">
<?php
  foreach ($master_activity as $act) {
    if($act->code_activity == $activity){
?>
                            <option value="<?php echo $act->code_activity; ?>" style="color:black;" selected><?php echo $act->desc_activity; ?></option>
<?php
    }
    else{
?>
                            <option value="<?php echo $act->code_activity; ?>" style="color:black;"><?php echo $act->desc_activity; ?></option>
<?php
    }
  }
?>
                  ...
                  <div class="card-body" style="padding:0;">
                    <table class="table_pm" style="font-weight:bold;">
                      <tr class="text-center" style="background-color:#008080;">
                        <td colspan="7" style="color:white;">List Activity</td>
                      </tr>
                      <tr class="text-center" style="background-color:#008080;">
                        <td style="color:white;">Lokasi</td>
                        <td style="color:white;">Status</td>
                        <td style="color:white;">Umur</td>
                        <td style="color:white;">Real</td>
...
?>
                      <tr class="text-center">
<?php
  if($la->keterangan == 'Rencana'){
?>
                        <td><a href='/PIS/index.php/WIP_PM_Lokasi/lokasi?lokasi=<?php echo $la->lokasi; ?>'><?php echo $la->lokasi; ?></a></td>
<?php
  }
  else{
?>
                        <td><?php echo $la->lokasi; ?></td>
<?php
  }
?>
                        <td><?php echo $la->status; ?></td>
                        <td><?php echo $la->umur; ?></td>
                        <td><?php echo angka_ribuan(ceil($la->r)); ?></td>
                        <td><?php echo angka_ribuan(round($la->budget)); ?></td>
                        <td style="color:<?php echo $color_over; ?>;"><?php echo angka_ribuan(abs(ceil($la->over_m))); ?></td>
...
<script>
  ...
  function select_main_filter(change){
    ...
    var ga = $('#select_group_activity').val();
    if(change == 1){
      window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&ga="+ga;
    }
    else{
      var activity = $('#select_activity').val();
      window.location.href="/PIS/index.php/WIP_PM_Dashboard/wilayah?page=<?php echo $page; ?>&wilayah="+wilayah+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&ga="+ga+"&activity="+activity;
    }
  }
