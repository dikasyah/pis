...
?>
                              <tr>
                                <td style="color:black;padding-top:1px;padding-bottom:1px;" align="right" width="30%"><?php echo $jarak_hari." H"; ?></td>
                                <td style="color:black;padding-top:1px;padding-bottom:1px;" align="right" width="40%">
                                  <a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&tgl=<?php echo $sm->tgl_realisasi; ?>&page=<?php echo $page; ?>&subpage=SPMN"><?php echo date('d/m/Y', strtotime($sm->tgl_realisasi)); ?></a>
                                </td>
                                <td class="text-right" style="color:black;padding-top:1px;padding-bottom:1px;" width="30%"><?php echo angka_ribuan($TotalBiayaMF / $HasilEfektif); ?></td>
                              </tr>
<?php
...
?>
                              <tr>
                                ...
                                <td class="text-right" style="color:black;padding-top:1px;padding-bottom:1px;" width="30%"><?php echo angka_ribuan($sm->total / $sm->luas_aktif); ?></td>
                              </tr>
<?php
      $jarak_hari = $sm->tgl_realisasi;
    }
...
?>
                    ...
                    <div class="col-lg-7 p-1">
                      <div class="card shadow" style="width:100%;">
                        <div class="card-header py-0 text-center" style="background-color:#008080;">
                          <span style="color:white;font-size:14px;"><b>Quantity Fertilizer</b></span>
                        </div>
                        <div class="card-body" style="padding:0;">
                          <table class="table_pm">
                            <tr class="text-center" style="background-color:#008080;font-weight:bold;">
...
?>
                              <td width="10px" style="background-color:<?php echo $color_std; ?>;">&nbsp;</td>
                              <td><a style="color:black;text-decoration:none;" href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code=NPK_Haracoat&page=<?php echo $page; ?>&subpage=SPMA">NPK Haracoat</a></td>
...
?>
                  ...
                  <div class="row mb-1">
                    <div class="col-lg-12 p-1">
                      <div class="card shadow" style="width:100%;">
                        <div class="card-header py-0 text-center" style="background-color:#008080;">
                          <span style="color:white;font-size:14px;"><b>Trend Fertilization</b></span>
                        </div>
