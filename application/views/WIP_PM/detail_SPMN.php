...
?>
                    <tr style="font-weight:bold;font-size:11px;">
                      ...
                      <td class="text-right"><?php echo angka_ribuan($spk->biaya_realisasi / $lokasi['luas']); ?></td>
...
<script>
  function pindah_tanggal(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&code="+tanggal+"&page=<?php echo $page; ?>&ec=ZN05&subpage=SPAC";
  }
