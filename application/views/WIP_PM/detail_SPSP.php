...
<script>
  function pindah_tanggal(){
    ...
    window.location.href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&tgl="+tanggal+"&page=<?php echo $page; ?>&ec=ZN05&subpage=SPSP";
  }
