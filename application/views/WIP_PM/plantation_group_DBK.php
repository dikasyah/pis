        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?pg=<?php echo $pg_desc['code']; ?>&page=BK" role="button" aria-expanded="false">
...
?>
                    <option value="Total" style="color:black;" <?php echo $OptionActivityBK0; ?>>Total</option>
                    <option value="Chopper" style="color:black;" <?php echo $OptionActivityBK1; ?>>Chopper</option>
                    <option value="Moldboard" style="color:black;" <?php echo $OptionActivityBK2; ?>>Moldboard</option>
                    <option value="Diskplow" style="color:black;" <?php echo $OptionActivityBK3; ?>>Diskplow</option>
                    <option value="Harrow" style="color:black;" <?php echo $OptionActivityBK4; ?>>Harrow</option>
                    <option value="SubSoiling" style="color:black;" <?php echo $OptionActivityBK5; ?>>Sub Soiling</option>
                    <option value="FinishRotary" style="color:black;" <?php echo $OptionActivityBK6; ?>>Finish Rotary</option>
                    <option value="FinishHarrow" style="color:black;" <?php echo $OptionActivityBK7; ?>>Finish Harrow</option>
                    <option value="Ridger" style="color:black;" <?php echo $OptionActivityBK8; ?>>Ridger</option>
                    <option value="Jalan" style="color:black;" <?php echo $OptionActivityBK9; ?>>Jalan</option>
                    <option value="Saluran" style="color:black;" <?php echo $OptionActivityBK10; ?>>Saluran</option>
                  </select>
                </div>
              </div>
            </div>
...
<script>
  ...
  function select_main_filter(){
    ...
    var pg = $('#pg').val();
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?page=<?php echo $page; ?>&pg="+pg+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&activity_bk="+activity_bk;
  }
</script>
