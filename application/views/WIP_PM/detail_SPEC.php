              ...
              <div class="col-lg-12 p-1">
                <div class="card shadow" style="width:100%;">
                  ...
                  <div class="card-body" style="padding:0;background-color:#20B2AA;">
                    <br />
                    <select class="form-control select" name="select_element_cost" id="select_element_cost" onchange="javascript:pindah_element_cost();" data-live-search="true" style="color:black;font-family:'Lucida Console'">
                      <option value="0" style="color:black;">Semua Element Cost</option>
<?php
  foreach ($element_cost_all as $aa) {
    if($element_cost == $aa->code){
?>
                      <option value="<?php echo $aa->code; ?>" selected><?php echo $aa->code." - ".$aa->nama; ?></option>
<?php
    }
    else{
?>
                      <option value="<?php echo $aa->code; ?>"><?php echo $aa->code." - ".$aa->nama; ?></option>
<?php
    }
  }
?>
...
?>
                      <tr>
                        <td>Material</td>
                        <td class="text-right"><?php echo angka_ribuan(0); ?></td>
                        <td class="text-right"><?php echo angka_ribuan(0); ?></td>
                      </tr>
                      <tr>
                        <td>Seed</td>
...
<?php
  ...
  $GroupCostTotal = $group_cost['charge'] + $group_cost['labour'] + $group_cost['material'];
  if(isset($ZN_real)){
    if($ZN_real != NULL){
      switch ($element_cost) {
        case 'ZN01':
        case 'ZN03':
        case 'ZN04':
          $GroupCostKOB1 = $ZN_real['total'] - $GroupCostTotal;
          $GroupCostTotal = $GroupCostTotal + $GroupCostKOB1;
?>
                      <tr>
                        <td>Varian (KOB1)</td>
                        <td class="text-right"><?php echo angka_ribuan(($GroupCostKOB1) / $ZN_real['luas']); ?></td>
                        <td class="text-right"><?php echo angka_ribuan($GroupCostKOB1); ?></td>
                      </tr>
<?php
      break;
      }
...
?>
                      <tr style="font-size:13px;font-weight:bold;">
                        <td>Total</td>
                        <td class="text-right"><?php echo angka_ribuan(($GroupCostTotal) / $lokasi['luas']); ?></td>
                        <td class="text-right"><?php echo angka_ribuan($GroupCostTotal); ?></td>
                      </tr>
                    </table>
                  </div>
                </div>
                ...
                <table class="table_pm">
                  <thead>
                    <tr class="text-center" style="background-color:#008080;font-weight:bold;font-size:12px;">
                      ...
                      <td style="color:white;">Jenis<br />Data</td>
...
?>
                    <tr style="font-weight:bold;font-size:11px;">
                      ...
                      <td><?php echo $spk->code_activity; ?></td>
                      <td><?php echo $spk->desc_activity; ?></td>
...
<script>
  function pindah_element_cost(){
    var code_element_cost = $("#select_element_cost").val();
    window.location.href="/PIS/index.php/WIP_PM_Lokasi/activity_detail?lokasi=<?php echo $lokasi['lokasi']; ?>&ec="+code_element_cost+"&page=<?php echo $page; ?>&subpage=SPEC";
  }
