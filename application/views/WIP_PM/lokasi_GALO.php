...
?>
                        <button onclick="show_modal_gallery('PM Pre Forcing')" <?php echo $disable; ?>  class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa fa-cloud-upload fa-sm text-white-50"></i> Upload</button>
<?php
  }
?>
                      </div>
...
?>
                        <button onclick="show_modal_gallery('PM Post Forcing')" <?php echo $disable; ?>  class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa fa-cloud-upload fa-sm text-white-50"></i> Upload</button>
<?php
  }
?>
                      </div>
...
?>
  ...
  ?>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="d-sm-flex align-items-center justify-content-between" style="padding:10px;">
                        <span style="color:black;"><b>Web GIS</b></span>
                      </div>
                      <div class="row mb-1">
  <?php
    foreach ($gallery['gis'] as $glp) {
  ?>
                        <div class="col-lg-3 text-center">
                          <div class="container">
                            <img class="p-1 images" href="<?php echo base_url() ?>/assets/upload/gis_pict/<?php echo $glp->image; ?>" src="<?php echo base_url() ?>/assets/upload/gis_pict/<?php echo $glp->image; ?>" alt="<?php echo base_url() ?>/assets/upload/gis_pict/<?php echo $glp->image; ?>" style="max-width:100%;max-height:300px;"/>
                            <div class="overlay">
                              <a class="icon" title="#">
                                <i onclick="show_modal_show_foto('<?php echo base_url() ?>/assets/upload/gis_pict/<?php echo $glp->image; ?>')" class="fa fa-search-plus"></i>
                              </a>
                            </div>
                            <div class="meta">
                              <strong><?php echo $glp->jenis; ?></strong><br />
                              <span><?php echo $glp->description; ?></span>
                              <span><?php echo format_tgl($glp->date); ?></span>
                            </div>
                          </div>
                        </div>
  <?php
...
<script>
  ...
  function runScript(e){
    if (e.keyCode == 13) {
      window.location.href="/PIS/index.php/WIP_PM_Lokasi/lokasi?page=GALO&lokasi="+$('#lokasi').val();
    }
  }
