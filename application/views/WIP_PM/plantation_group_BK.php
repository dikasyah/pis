...
?>
                          <tr style="font-weight:bold;">
                            <td style="color:black;padding-top:2px;padding-bottom:2px;"><a style="color:blue;text-decoration:none;" href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?page=DEC&pg=<?php echo $pg_desc['code']; ?>&ga=<?php echo $ec->code; ?>&jenis_status=BK"><?php echo $ec->nama; ?></a></td>
        ...
        xAxes: [{
          gridLines: {
            ...
            drawOnChartArea: false,
              ...
              <div class="row mb-1">
                <div class="col-lg-6 p-1">
                  <button type="button" name="button" class="form-control btn btn-primary" onclick="DescriptionCharge('<?php echo $pg_desc['code']; ?>')">Description Charge</button>
                </div>
                <div class="col-lg-6 p-1">
                  <div class="card shadow" style="width:100%;">
                    <div class="card-body" style="padding:0;">
...
<?php
  if($ActivityPenarik["Total"] != NULL || $ActivityPenarik["Total"] != 0){
...
<script>
  ...
  function select_main_filter(){
    ...
    var pg = $('#pg').val();
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?page=<?php echo $page; ?>&pg="+pg+"&status="+status+"&jenis="+jenis+"&kelas="+kelas+"&tahun="+tahun+"&bulan="+bulan+"&umur="+umur+"&status_bk="+status_bk+"&activity_bk="+activity_bk+"&qbk="+qbk;
  }
  ...
  function DescriptionCharge(pg){
    window.location.href="/PIS/index.php/WIP_PM_Dashboard/plantation_group?pg="+pg+"&page=DBK";
  }
</script>
