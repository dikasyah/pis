                                ...
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Pre Emergency</b></td>
...
<?php
  $row_num = 0;
  foreach($performance['quantity']['pre_emergency'] as $q1){
    if($row_num % 2 == 0){
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Post Emergency</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quantity']['post_emergency'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Booster</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quantity']['booster'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
                            ...
                            <div class="col-md-12">
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Sanitation</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['quality']['sanitation'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
                            ...
                            <div class="col-md-12">
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Weed Control (HPP)</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['weed_control_hpp'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
...
?>
                              ...
                              <div class="col-md-3">
                                <table class="table table-actions">
                                  <tbody>
                                    <tr style="background-color: #32CD32;">
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;"><b>Weed Control (WIP)</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#FF0000;" align='center'><b>PG1</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#00008B;" align='center'><b>PG2</b></td>
                                      <td style="color:black;padding-top:2px;padding-bottom:2px;color:#228B22;" align='center'><b>PG3</b></td>
                                    </tr>
<?php
  $row_num = 0;
  foreach($performance['cost']['weed_control_wip'] as $q1){
    if($row_num % 2 == 0){
      $color_row = "style='background-color:#F5F5F5;'";
    }
    else{
